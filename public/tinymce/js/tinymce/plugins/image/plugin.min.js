...
!(function () {
    ...
    function q() {
        return { src: '', alt: '', title: '', width: '', height: '', class: '', style: '', caption: !1, hspace: '', vspace: '', border: '', borderStyle: '', isDecorative: !1 }
    }
    function Q(e, t) {
        return { src: M(t, 'src'), alt: Z((n = t)) ? '' : M(n, 'alt'), title: M(t, 'title'), width: W(t, 'width'), height: W(t, 'height'), class: M(t, 'class'), style: e(M(t, 'style')), caption: B(t), hspace: R(t), vspace: k(t), border: z(t), borderStyle: j(t, 'borderStyle'), isDecorative: Z(t) }
        var n
    }
    ...
    function ae(r, e) {
        var t = (function (e) {
            ...
            if (
                ...
                return n.appendChild(t), n.appendChild(we.create('figcaption', { contentEditable: 'true' }, 'Caption')), (n.contentEditable = 'false'), n
            }
            return t
        })(e)
    ...
    function le(e) {
        var t = e.imageList.map(function (e) {
            ...
            n = { name: 'alt', type: 'input', label: 'Alternative description', disabled: e.hasAccessibilityOptions && e.image.isDecorative },
        ...
        return S([
            ...
            t.toArray(),
            e.hasAccessibilityOptions && e.hasDescription ? [{ type: 'label', label: 'Accessibility', items: [{ name: 'isDecorative', type: 'checkbox', label: 'Image is decorative' }] }] : [],
            e.hasDescription ? [n] : [],
            e.hasImageTitle ? [{ name: 'title', type: 'input', label: 'Image title' }] : [],
            e.hasDimensions ? [{ name: 'dimensions', type: 'sizeinput' }] : [],
            [y(y({}, e.classList.isSome() && e.hasImageCaption ? { type: 'grid', columns: 2 } : { type: 'panel' }), { items: S([r.toArray(), e.hasImageCaption ? [{ type: 'label', label: 'Caption', items: [{ type: 'checkbox', name: 'caption', label: 'Show caption' }] }] : []]) })],
        ])
    }
    function se(e) {
        return { src: { value: e.src, meta: {} }, images: e.src, alt: e.alt, title: e.title, dimensions: { width: e.width, height: e.height }, classes: e.class, caption: e.caption, style: e.style, vspace: e.vspace, border: e.border, hspace: e.hspace, borderstyle: e.borderStyle, fileinput: [], isDecorative: e.isDecorative }
    }
    function ce(e, t) {
        return { src: e.src.value, alt: 0 === e.alt.length && t ? null : e.alt, title: e.title, width: e.dimensions.width, height: e.dimensions.height, class: e.classes, style: e.style, caption: e.caption, hspace: e.hspace, vspace: e.vspace, border: e.border, borderStyle: e.borderstyle, isDecorative: e.isDecorative }
    }
    function ue(e, t, n, r) {
        ...
        ;(U = t),
            ...
            void 0 !== (S = w.src.meta) &&
                ...
                v.hasAccessibilityOptions && (A.isDecorative = D.isDecorative || A.isDecorative || !1),
                v.hasImageTitle && T(D.title) && (A.title = D.title),
                v.hasDimensions && (T(D.width) && (A.dimensions.width = D.width), T(D.height) && (A.dimensions.height = D.height)),
                T(D.class) &&
                    Pe(v.classList, D.class).each(function (e) {
                        A.classes = e.value
                    }),
                v.hasImageCaption && N(D.caption) && (A.caption = D.caption),
                v.hasAdvTab && (T(D.style) && (A.style = D.style), T(D.vspace) && (A.vspace = D.vspace), T(D.border) && (A.border = D.border), T(D.hspace) && (A.hspace = D.hspace), T(D.borderstyle) && (A.borderstyle = D.borderstyle)),
                b.setData(y)),
            (a = e),
            (i = t),
            (o = n),
        ...
        c.block('Uploading image'),
            (0 < (e = n.fileinput).length ? L.some(e[0]) : L.none()).fold(
                ...
                function (n) {
                    ...
                    function a(e) {
                        c.setData({ src: { value: e, meta: {} } }), c.showTab('general'), ue(l, s, t, c)
                    }
        ...
        return function (e, t) {
            ...
            'src' === t.name
                ...
                ? ((o = S),
                  ...
                  (v = o.serializeStyle),
                  (D = _(y((A = s).style))),
                  ((w = Ce({}, A)).vspace = D['margin-top'] && D['margin-bottom'] && D['margin-top'] === D['margin-bottom'] ? O(String(D['margin-top'])) : ''),
                  (w.hspace = D['margin-right'] && D['margin-left'] && D['margin-right'] === D['margin-left'] ? O(String(D['margin-right'])) : ''),
        ...
        var t,
            ...
            A = {
                ...
                createBlobCache: function (e, t, n) {
                    return o.editorUpload.blobCache.create({ blob: e, blobUri: t, name: e.name ? e.name.replace(/\.[^\.]+$/, '') : null, filename: e.name, base64: n.split(',')[1] })
                },
                alertErr: function (e) {
        ...
        return {
            open: function () {
                ...
                ;(r = v),
                    ...
                    n
                        .then(function (e) {
                            return { image: m, imageList: e, classList: o, hasAdvTab: l, hasUploadTab: s, hasUploadUrl: c, hasUploadHandler: u, hasDescription: d, hasImageTitle: g, hasDimensions: p, hasImageCaption: f, prependURL: y, hasAccessibilityOptions: h, automaticUploads: b }
                        })
                        .then(
                            ((i = A),
                            function (e) {
                                var t,
                                    n,
                                    r,
                                    a = { prevImage: Pe((t = e).imageList, t.image.src), prevAlt: t.image.alt, open: !0 }
                                return {
                                    title: 'Insert/Edit Image',
                                    size: 'normal',
                                    body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? { type: 'tabpanel', tabs: S([[Ee(r)], r.hasAdvTab ? [_e(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [ke(r)] : []]) } : { type: 'panel', items: Re(r) },
                                    buttons: [
                            ...
                            ? ((n = Q(function (e) {
                              ...
                              (r = y(y({}, n), e)).src
                                  ? ((c = r),
                                    ...
                                    X(p.parentNode)
                                        ? ((u = p.parentNode), re(s, u), s.selection.select(p.parentNode))
                                        : (s.selection.select(p),
                                          (m = s),
                                          (d = c),
                                          ((g = p).onload = function () {
                                              d.width || d.height || !I(m) || m.dom.setAttribs(g, { width: String(g.clientWidth), height: String(g.clientHeight) }), f()
                                          }),
                                          (g.onerror = f)))
                                  : ((a = t), (i = l) && ((o = a.dom.is(i.parentNode, 'figure.image') ? i.parentNode : i), a.dom.remove(o), a.focus(), a.nodeChanged(), a.dom.isEmpty(a.getBody()) && (a.setContent(''), a.selection.setCursorLocation()))))
                            : e.src && ae(t, y(y({}, q()), e))
                })
            })
    }
    ...
    var be,
        ...
        Ue = function (e, t, n) {
            ...
            Y(n, r, t, 'caption', function (e, t, n) {
                return B((r = e)) ? ((o = r.parentNode), we.insertAfter(r, o), we.remove(o)) : ((a = r), (i = we.create('figure', { class: 'image' })), we.insertAfter(i, a), i.appendChild(a), i.appendChild(we.create('figcaption', { contentEditable: 'true' }, 'Caption')), (i.contentEditable = 'false')), 0
                var r, a, i, o
            }),
                Y(n, r, t, 'src', H),
                Y(n, r, t, 'title', H),
                ...
                (t.alt === r.alt && t.isDecorative === r.isDecorative) || Se(n, t.alt, t.isDecorative)
        },
        Ce =
            ((be = function (e, t) {
        ...
        Oe = function (e, i) {
            ...
            return (
                xe.each(e, function (e) {
                    ...
                    void 0 !== e.menu ? ((n = Oe(e.menu, i)), o.push({ text: a, items: n })) : ((r = i(e)), o.push({ text: a, value: r }))
                }),
                o
            )
        },
    ...
    o.add('image', function (e) {
        ...
        ;(t = e).on('PreInit', function () {
            ...
            n.ui.registry.addMenuItem('image', { icon: 'image', text: 'Image...', onAction: ge(n).open }),
