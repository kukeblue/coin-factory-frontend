...
!(function () {
                ...
                new s(function (n) {
                    ...
                    0 < t.length &&
                        ...
                        new s(function (t) {
                            ...
                            var e, n, r, o, i, u
                            ;(n = t), (r = c), (i = (e = a).editorUpload.blobCache), (u = i.create(((o = new Date().getTime()), 'mceu_' + Math.floor(1e9 * Math.random()) + ++l + String(o)), r, n)), i.add(u), e.insertContent(e.dom.createHTML('img', { src: u.blobUri() }))
                        }))
                })
            },
        }),
    ...
    function t(r) {
        return function (t) {
            return (n = typeof (e = t)), (null === e ? 'null' : 'object' == n && (Array.prototype.isPrototypeOf(e) || (e.constructor && 'Array' === e.constructor.name)) ? 'array' : 'object' == n && (String.prototype.isPrototypeOf(e) || (e.constructor && 'String' === e.constructor.name)) ? 'string' : n) === r
            var e, n
        }
    }
    function e(e) {
    ...
    c.add('quickbars', function (t) {
        var o, e
        n(t),
            0 < (e = x((o = t), 'quickbars_insert_toolbar', 'quickimage quicktable')).trim().length &&
            ...
            (function (e) {
                ...
                0 < t.trim().length && e.ui.registry.addContextToolbar('imageselection', { predicate: n, items: t, position: 'node' })
