...
!(function () {
    ...
    function r(e, t) {
        var o,
            ...
            l = d(e)
        l
            ? ((n = e), (r = t), (i = l).removeAttribute('name'), (i.id = r), n.addVisual(), n.undoManager.add())
            : ((a = t),
    ...
    e.add('anchor', function (e) {
        ...
        ;(t = e).on('PreInit', function () {
                ...
                ;(t = (e = d((o = n))) ? a(e) : ''),
                    o.windowManager.open({
                        ...
                        onSubmit: function (e) {
                            var t = o,
                                n = e.getData().id
                            ;(/^[A-Za-z][A-Za-z0-9\-:._]*$/.test(n) ? (r(t, n), 0) : (t.windowManager.alert('Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.'), 1)) || e.close()
                        },
                    })
            }),
            ...
            e.on('PreInit', function () {
                e.formatter.register('namedAnchor', { inline: 'a', selector: l, remove: 'all', split: !0, deep: !0, attributes: { id: '%value' }, onmatch: c })
            })
    })
})()
