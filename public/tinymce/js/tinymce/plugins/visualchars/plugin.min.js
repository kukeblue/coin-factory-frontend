...
!(function () {
    ...
    var o,
        ...
        u = function (n) {
            return (e = typeof (t = n)), (null === t ? 'null' : 'object' == e && (Array.prototype.isPrototypeOf(t) || (t.constructor && 'Array' === t.constructor.name)) ? 'array' : 'object' == e && (String.prototype.isPrototypeOf(t) || (t.constructor && 'String' === t.constructor.name)) ? 'string' : e) === o
            var t, e
        },
        c = n('boolean'),
        a = n('number'),
    ...
    function S(f, n) {
        m(K(M.fromDom(n), O), function (n) {
            var t,
                ...
                i,
                u = n.dom.parentNode
            if (C(u)) (t = M.fromDom(u)), (e = U), T(t) ? t.dom.classList.add(e) : ((r = e), (i = w((o = t), 'class').concat([r])), y(o, 'class', i.join(' ')))
            else {
    ...
    r.add('visualchars', function (n) {
        ...
        return (
            x(n, l),
            (o = n).ui.registry.addToggleButton('visualchars', { tooltip: 'Show invisible characters', icon: 'visualchars', onAction: d, onSetup: B(o, (r = l)) }),
            o.ui.registry.addToggleMenuItem('visualchars', { text: 'Show invisible characters', icon: 'visualchars', onAction: d, onSetup: B(o, r) }),
            (i = n),
            (u = l),
