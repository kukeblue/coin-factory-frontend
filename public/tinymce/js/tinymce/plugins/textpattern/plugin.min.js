...
!(function () {
            ...
            return void 0 !== o.replacement
                ? f(o.replacement)
                    ? 0 === o.start.length
                        ...
                        : ut.value({ type: 'inline-command', start: '', end: o.start, cmd: 'mceInsertContent', value: o.replacement })
    ...
    function H(t, n) {
        ...
        return (
            ...
            i.bind(function (t) {
                return j(t) && (e < 0 || e > t.data.length) ? w.none() : w.some({ node: t, offset: e })
            })
        )
    }
    function J(n, r) {
        ...
        return V(e, t)
            ...
            .bind(function (n) {
                ...
                return (function (t, n, r) {
                    ...
                    return dt.trim(e).length === t.start.length ? [] : [{ pattern: t, range: G(i.getRoot(), n, 0, n, 0) }]
                })
            })
            .getOr([])
    }
    ...
    function Y(t, n, r) {
        ...
        return { prefix: n, end: i.parentNode.insertBefore(z(t, n + '-end'), i), start: u.parentNode.insertBefore(z(t, n + '-start'), u) }
    }
    function Z(t, n, r) {
        ...
        0 !== t.length &&
            ...
            v(
                ...
                function (t) {
                    ...
                    L(t.pattern) ? ((e = t.pattern), (o = t.endMarker), (a = n), (i = Q((r = p).dom, o)), _(r.dom, i, a), $(r, e, i)) : ((u = p), (f = t.pattern), (c = t.startMarker), (s = t.endMarker), (l = n), (d = u.dom), (m = Q(d, s)), _(d, Q(d, c), l), _(d, m, l), $(u, f, Q(d, { prefix: c.prefix, start: c.end, end: s.start }))), Z(h, t.endMarker, n), Z(h, t.startMarker, n)
                }
            ),
                                            ...
                                            0 !== (t = u).length &&
                                                ...
                                                v(t, function (t) {
                                                    return (
                                                        (e = (n = i).dom),
                                                        (o = (r = t).pattern),
                                                        (a = J(e.getRoot(), r.range).getOrDie('Unable to resolve path range')),
                    ...
                    if (((a = (r = e).length - f.length), '' === (i = f) || (r.length >= i.length && r.substr(a, a + i.length) === i))) {
                        ...
                        var s = (function (a, i, u) {
                            ...
                            return vt(l, d - u.pattern.end.length, i).bind(function (t) {
                                ...
                                if (L(s)) return w.some({ matches: [{ pattern: s, startRng: r, endRng: r }], position: t })
                                ...
                                return (function (t, r, n, e, o, a) {
                                    ...
                                    return { matches: e.matches.concat([{ pattern: s, startRng: n, endRng: r }]), position: I(t.startContainer, t.startOffset) }
                                })
                            })
        ...
        var t,
            ...
            o =
                ((t = (function () {
                    ...
                    if (!s(t)) return B('The setting textpattern_patterns should be an array'), { inlinePatterns: [], blockPatterns: [] }
                    var n = T(h(t, S))
                    return (
        ...
        return (
            ...
            (e = o),
            {
                ...
                getPatterns: function () {
                    return a(a([], h(e.get().inlinePatterns, M)), h(e.get().blockPatterns, M))
                },
            }
        )
    })
