...
!(function () {
    'use strict'
    function f(t, e, n) {
        t.execCommand('UL' === e ? 'InsertUnorderedList' : 'InsertOrderedList', !1, !1 === n ? null : { 'list-style-type': n })
    }
    function i(t) {
        return function () {
            return t
    ...
    n.add('advlist', function (t) {
        var n, e, r, o
        t.hasPlugin('lists')
            ? (c((e = t), 'numlist', 'Numbered list', 'InsertOrderedList', 'OL', (r = e.getParam('advlist_number_styles', 'default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman')) ? r.split(/[ ,]/) : []),
              c(e, 'bullist', 'Bullet list', 'InsertUnorderedList', 'UL', (o = e.getParam('advlist_bullet_styles', 'default,circle,square')) ? o.split(/[ ,]/) : []),
