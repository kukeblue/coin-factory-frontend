...
!(function () {
    ...
    function V(e) {
        ...
        var n = e.current,
            r = e.version
        return { current: n, version: r, isEdge: t('Edge'), isChrome: t('Chrome'), isIE: t('IE'), isOpera: t('Opera'), isFirefox: t(ne), isSafari: t('Safari') }
    }
    function W(e) {
        function t(e) {
            return function () {
        ...
        var n = e.current,
            r = e.version
        return { current: n, version: r, isWindows: t(ie), isiOS: t('iOS'), isAndroid: t(ae), isOSX: t('OSX'), isLinux: t('Linux'), isSolaris: t(se), isFreeBSD: t(ue), isChromeOS: t(ce) }
    }
    function Q(e) {
    ...
    var X,
        ...
        te = {
            browsers: S([
                ...
                { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: _('firefox') },
                {
                    name: 'Safari',
            ...
            oses: S([
                { name: 'Windows', search: _('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
                {
                    name: 'iOS',
                    search: function (e) {
                ...
                { name: 'Android', search: _('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
                { name: 'OSX', search: _('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
                ...
                { name: 'ChromeOS', search: _('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
            ]),
        },
        ne = 'Firefox',
        re = function () {
                ...
                return (
                        ...
                        .fold(fe, de)),
                    {
                        ...
                        deviceType:
                            ...
                            { isiPad: S(u), isiPhone: S(c), isTablet: S(l), isPhone: S(m), isTouch: S(d), isAndroid: o.isAndroid, isiOS: o.isiOS, isWebView: S(p), isDesktop: S(!m && !l && !p) }),
                    }
                )
    ...
    function He(e, t) {
        ...
        if ((c && ((o = a.create(c)).tagName === c.toUpperCase() && a.setAttribs(o, e.getParam('forced_root_block_attrs', {})), _e(t.firstChild, s) || u.appendChild(o)), t))
            for (; (r = t.firstChild); ) {
                var f = r.nodeName
        ...
        return c ? i || o.appendChild(a.create('br', { 'data-mce-bogus': '1' })) : u.appendChild(a.create('br')), u
    }
    function je(e) {
        Qt(e) && Pe(e, 'dd')
    }
    ...
    function Ve(e, t) {
        ...
        return Me(n) ? { container: n, offset: t >= e.childNodes.length ? n.data.length : 0 } : n.previousSibling && Me(n.previousSibling) ? { container: n.previousSibling, offset: n.previousSibling.data.length } : n.nextSibling && Me(n.nextSibling) ? { container: n.nextSibling, offset: 0 } : { container: e, offset: t }
    }
    function We(e) {
        var t = e.cloneRange(),
    ...
    function tt(e, t, n) {
        var r,
            o = (function (e, t, n) {
                for (var r, o, i, a = [], s = 0; s < n; s++) a.push(((o = t.listType), we((i = { list: me.fromTag(o, (r = e)), item: me.fromTag('li', r) }).list, i.item), i))
                return a
                ...
                ;(i = (r = s)[(o = e)].depth),
                    v(D(r.slice(0, o)), t, n)
                        ...
                        .fold(
                            ...
                            function (e) {
                                var t = e
                                ;(a.listType = t.listType), (a.listAttributes = B({}, t.listAttributes))
                            }
                        )
            }),
            s
                    ...
                    var r,
                        ...
                        e =
                            ...
                            Oe(r)
                                .filter(Bt)
                                .map(function (e) {
                                    return { depth: o, dirty: !1, isSelected: i, content: ((n = Le((t = r))), C(xe(t).exists(nt) ? n.slice(0, -1) : n, Ie)), itemAttributes: Ne(r), listAttributes: Ne(e), listType: Se(e) }
                                    var t, n
                                }))
                    a.each(function (e) {
                        F(e.end, u) && s.set(!1)
    ...
    function gt(o) {
        function e(e) {
            ...
            1 === n.nodeType && ((t = Gt.create('span', { 'data-mce-type': 'bookmark' })), n.hasChildNodes() ? ((r = Math.min(r, n.childNodes.length - 1)), e ? n.insertBefore(t, n.childNodes[r]) : Gt.insertAfter(t, n.childNodes[r])) : n.appendChild(t), (n = t), (r = 0)), (i[e ? 'startContainer' : 'endContainer'] = n), (i[e ? 'startOffset' : 'endOffset'] = r)
        }
        var i = {}
        ...
        'false' !== l.getContentEditable(u.selection.getNode()) &&
            ...
            Mt.each(t, function (e) {
                var t,
                    ...
                    s = e.parentNode
                Ft(s) ||
                    (a && Ut(a) && a.nodeName === c && ((o = f), l.getStyle(a, 'list-style-type') === (i = null === (i = o ? o['list-style-type'] : '') ? '' : i)) ? ((t = a), (e = l.rename(e, d)), a.appendChild(e)) : ((t = l.create(c)), e.parentNode.insertBefore(t, e), t.appendChild(e), (e = l.rename(e, d))),
                    (n = l),
                    (r = e),
                    Mt.each(['margin', 'margin-right', 'margin-bottom', 'margin-left', 'margin-top', 'padding', 'padding-right', 'padding-bottom', 'padding-left', 'padding-top'], function (e) {
                        var t
            ...
            ? ((l = e),
              ...
              (S = Ut((m = C))) && m.nodeName === g && !en(h)
                  ...
                  : (Ot(l, g, h),
                    ...
                    (y = S
                        ? (function (e, t) {
                              if (2 === arguments.length) for (var n, r = 0, o = t.length; r < o; r++) (!n && r in t) || ((n = n || Array.prototype.slice.call(t, 0, r))[r] = t[r])
                    ...
                    Mt.each(y, function (e) {
                        var t,
                            ...
                            o = g,
                            i = h
                        ;(t = e).nodeName !== o ? ((n = r.dom.rename(t, o)), bt(r.dom, n, i), Ze(r, vt(o), n)) : (bt(r.dom, t, i), Ze(r, vt(o), t))
                    }),
                    l.selection.setRng(ht(v))))
            : ((i = t), (a = N), (o = C) !== (r = e).getBody() && (o ? (o.nodeName !== i || en(a) || yt(o) ? ((s = gt(r.selection.getRng())), bt(r.dom, o, a), (u = r.dom.rename(o, i)), Jt(r.dom, u), r.selection.setRng(ht(s)), Ot(r, i, a), Ze(r, vt(i), u)) : pt(r)) : (Ot(r, i, a), Ze(r, vt(i), o))))
    }
    function Dt(e, t, n, r) {
            ...
            if (m && m !== d)
                return (
                    c.undoManager.transact(function () {
                        ...
                        f
                            ? ((t = l), (n = m), (r = d), (u = (e = c).dom).isEmpty(r) ? ((a = n), (i = e).dom.$((s = r)).empty(), At(i.dom, a, s), i.selection.setCursorLocation(s, 0)) : ((o = gt(t)), At(u, n, r), e.selection.setRng(ht(o))))
            ...
            ;(r = Qe((t = o))),
                $t(r) &&
                    t.windowManager.open({
                        ...
                        initialData: { start: ((e = { start: t.dom.getAttrib(r, 'start', '1'), listStyleType: E.some(t.dom.getStyle(r, 'list-style-type')) }), (n = parseInt(e.start, 10)), ze(e.listStyleType, 'upper-alpha') ? nn(n) : ze(e.listStyleType, 'lower-alpha') ? nn(n).toLowerCase() : e.start) },
                        buttons: [
                        ...
                        onSubmit: function (e) {
                            !(function (e) {
                                switch (/^[0-9]+$/.test((t = e)) ? 2 : /^[A-Z]+$/.test(t) ? 0 : /^[a-z]+$/.test(t) ? 1 : 0 < t.length ? 4 : 3) {
                                    ...
                                    case 0:
                                        return E.some({ listStyleType: E.some('upper-alpha'), start: Et(e).toString() })
                                    case 1:
                                        return E.some({ listStyleType: E.some('lower-alpha'), start: Et(e).toString() })
                                    case 3:
                                ...
                                t.execCommand('mceListUpdate', !1, { attrs: { start: '1' === e.start ? '' : e.start }, styles: { 'list-style-type': e.listStyleType.getOr('') } })
                            }),
                                e.close()
                        },
                    })
            ...
            !1 === e.hasPlugin('rtc', !0)
                ? ((a = e).getParam('lists_indent_on_tab', !0) &&
                  ...
                  (u = a).on('keydown', function (e) {
                      e.keyCode === ve.BACKSPACE ? kt(u, !1) && e.preventDefault() : e.keyCode === ve.DELETE && kt(u, !0) && e.preventDefault()
                  }),
