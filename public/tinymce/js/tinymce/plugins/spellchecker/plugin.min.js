...
!(function () {
                        ...
                        (function (e, t, n) {
                            ...
                            e: for (;;) {
                                if (((f[u.nodeName] || g[u.nodeName] || p(u)) && l++, 3 === u.nodeType && (!o && u.length + l >= c.end ? ((o = u), (i = c.end - l)) : r && s.push(u), !r && u.length + l > c.start && ((r = u), (a = c.start - l)), (l += u.length)), r && o)) {
                                    if (((u = n({ startNode: r, startNodeIndex: a, endNode: o, endNodeIndex: i, innerNodes: s, match: c.text, matchIndex: d })), (l -= o.length - i), (o = r = null), (s = []), d++, !(c = t.shift()))) break
    ...
    function M(t, e, n, r, o, a) {
        i(t, n, r) ||
            ...
            k(
                ...
                function (e) {
                    t.notificationManager.open({ text: e, type: 'error' }), t.setProgressState(!1), i(t, n, r)
                }
            ),
            t.focus())
    }
    ...
    var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        O = function (t, e, n, r, o) {
            ...
            l(t, n)
                ...
                .wrap(function (e) {
                    return t.dom.create('span', { class: 'mce-spellchecker-word', 'aria-invalid': 'spelling', 'data-mce-bogus': 1, 'data-mce-word': e.text })
                }),
    ...
    e.add('spellchecker', function (e, t) {
        if (0 == (!!e.hasPlugin('tinymcespellchecker', !0) && (void 0 !== window.console && window.console.log && window.console.log("Spell Checker Pro is incompatible with Spell Checker plugin! Remove 'spellchecker' from the 'plugins' option."), !0))) {
            ...
            var n = I(!1),
                r = I(((C = (P = e).getParam('language', 'en')), P.getParam('spellchecker_language', C))),
                o = I(null),
                a = I(null)
            return (
                (c = e),
                ...
                (d = r),
                (f = a),
                (h = _.map(c.getParam('spellchecker_languages', 'English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,German=de,Italian=it,Polish=pl,Portuguese=pt_BR,Spanish=es,Swedish=sv').split(','), function (e) {
                    var t = e.split('=')
                ...
                1 < p.length ? c.ui.registry.addSplitButton('spellchecker', v) : c.ui.registry.addToggleButton('spellchecker', m),
