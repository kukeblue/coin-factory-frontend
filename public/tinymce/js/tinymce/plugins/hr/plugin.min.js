...
!(function () {
    tinymce.util.Tools.resolve('tinymce.PluginManager').add('hr', function (n) {
        ...
        ;(o = n).addCommand('InsertHorizontalRule', function () {
            ...
            (t = n).ui.registry.addButton('hr', { icon: 'horizontal-rule', tooltip: 'Horizontal line', onAction: e }),
            t.ui.registry.addMenuItem('hr', { icon: 'horizontal-rule', text: 'Horizontal line', onAction: e })
    })
})()
