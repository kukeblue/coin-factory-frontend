...
!(function () {
                        ...
                        d(o, function (t, n) {
                            var e,
                                ...
                                c = {
                                    ...
                                    keywords: t.keywords,
                                    char:
                                        (i = (r = t).char).length >= (a = '<img').length && i.substr(0, 0 + a.length) === a
        ...
        f.focus(S),
            i.hasLoaded() ||
                ...
                i
                    ...
                    .catch(function (t) {
                        f.redial({ title: 'Emoticons', body: { type: 'panel', items: [{ type: 'alertbanner', level: 'error', icon: 'warning', text: '<p>Could not load emoticons</p>' }] }, buttons: [{ type: 'cancel', text: 'Close', primary: !0 }], initialData: { pattern: '', results: [] } }), f.focus(S), f.unblock()
                    }))
    }
    function b(t) {
    ...
    var u = function (e) {
        ...
        P = 'All',
        D = { symbols: 'Symbols', people: 'People', animals_and_nature: 'Animals and Nature', food_and_drink: 'Food and Drink', activity: 'Activity', travel_and_places: 'Travel and Places', objects: 'Objects', flags: 'Flags', user: 'User Defined' },
        S = 'pattern'
    e.add('emoticons', function (t, n) {
        ...
        ;(a = m),
            ...
            (c = t).ui.registry.addButton('emoticons', { tooltip: 'Emoticons', icon: 'emoji', onAction: g }),
            c.ui.registry.addMenuItem('emoticons', { text: 'Emoticons...', icon: 'emoji', onAction: g }),
            (l = m),
