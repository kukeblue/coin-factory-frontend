...
!(function () {
    ...
    function I(t, n) {
        return (n = n || t.selection.getNode()), pt(n) ? t.dom.select('a[href]', n)[0] : t.dom.getParent(n, 'a[href]')
    }
    function K(t, n) {
        return (n ? n.innerText || n.textContent : t.getContent({ format: 'text' })).replace(/\uFEFF/g, '')
    }
    function z(t) {
    ...
    function V(l, c, f) {
        var t,
            ...
            g =
                ...
                (u = st({}, e)),
                0 < P(n).length || !1 !== T(n) || ((r = B(u.rel, '_blank' === u.target)), (u.rel = r || null)),
                it.from(u.target).isNone() && !1 === A(n) && (u.target = N(n)),
                (u.href = ((o = u.href), ('http' !== (i = C(n)) && 'https' !== i) || U(o) ? o : i + '://' + o)),
                u)
    ...
    function q(t, n, e) {
        ...
        t.hasPlugin('rtc', !0)
            ? t.execCommand(
                  ...
                  (f = e.title),
                  R(
                      { class: i.getOrNull(), href: u, rel: a.getOrNull(), target: l.getOrNull(), text: c.getOrNull(), title: f.getOrNull() },
                      function (t, n) {
                          return !1 === s(t)
                      },
                      ((r = o = {}),
    ...
    function F(t) {
        ...
        t.hasPlugin('rtc', !0)
            ...
            : (l = t).undoManager.transact(function () {
                  ...
                  pt(a) ? vt(l, a) : ((n = (t = l).dom), (r = (e = t.selection).getBookmark()), (o = e.getRng().cloneRange()), (i = n.getParent(o.startContainer, 'a[href]', t.getBody())), (u = n.getParent(o.endContainer, 'a[href]', t.getBody())), i && o.setStartBefore(i), u && o.setEndAfter(u), e.setRng(o), t.execCommand('unlink'), e.moveToBookmark(r)), l.focus()
              })
    }
    function W(t) {
        var n = t.href
            ...
            .then(function (t) {
                var n,
                    ...
                    r = function (t) {
                        ...
                        var r = { href: e.url.value, text: n('text'), target: n('target'), rel: n('rel'), class: n('linkClass'), title: n('title') },
                            o = { href: e.url.value, attach: void 0 !== e.url.meta && e.url.meta.attach ? e.url.meta.attach : h }
                    ...
                    a = (n = u = t).anchor.text
                        ...
                        .toArray(),
                    l = n.flags.titleEnabled ? [{ name: 'title', type: 'input', label: 'Title' }] : [],
                    c = it.from(N(o)),
                    f = n.anchor,
                    s = { url: { value: (e = f.url.getOr('')), meta: { original: { value: e } } }, text: f.text.getOr(''), title: f.title.getOr(''), anchor: e, link: e, rel: f.rel.getOr(''), target: f.target.or(c).getOr(''), linkClass: f.linkClass.getOr('') },
                    m = n.catalogs,
                    g = xt(s, m)
                return {
    ...
    var ot = function (e) {
        ...
        ct = function (t, i) {
            ...
            return (
                lt.each(t, function (t) {
                    ...
                    void 0 !== t.menu ? ((e = ct(t.menu, i)), u.push({ text: o, items: e })) : ((r = i(t)), u.push({ text: o, value: r }))
                }),
                u
            )
        },
        ...
        yt = function (e, t) {
            return b(t, function (t) {
                return D((n = t), 'items') && void 0 !== n.items && null !== n.items ? yt(e, t.items) : w(t.value === e, t)
                var n
            })
        },
        xt = function (t, c) {
                ...
                return (
                    ...
                    void 0 !== u
                        ? yt(u, i).map(function (t) {
                              return { url: { value: t.value, meta: { text: a ? r : t.text, attach: h } }, text: a ? r : t.text }
                          })
                        : it.none()
                )
            }
                    ...
                    return 'url' === l
                        ? ((r = t()),
                          ...
                          u.isSome() || a.isSome()
                              ...
                              : it.none())
                        : ((e = ['anchor', 'link']), -1 < ut.call(e, l) ? f(t(), n) : (('text' !== l && 'title' !== l) || (s[l] = t()[l]), it.none()))
                },
            }
        },
                ...
                new Ot(function (n) {
                    ...
                    .then(function (t) {
                        var n,
                            ...
                            c,
                            f,
                            s = ((e = g), (r = (n = m).dom), (o = j(n) ? it.some(K(n.selection, e)) : it.none()), (i = e ? it.some(r.getAttrib(e, 'href')) : it.none()), (u = e ? it.from(r.getAttrib(e, 'target')) : it.none()), (a = H(r, e, 'rel')), (l = H(r, e, 'class')), { url: i, text: o, title: H(r, e, 'title'), target: u, rel: a, linkClass: l })
                        return {
                            anchor: s,
                            catalogs: {
                                targets:
    ...
    a.add('link', function (t) {
        ...
        ;(n = t).ui.registry.addToggleButton('link', { icon: 'link', tooltip: 'Insert/edit link', onAction: Q(n), onSetup: tt(n) }),
            n.ui.registry.addButton('openlink', { icon: 'new-tab', tooltip: 'Open link', onAction: Y(n), onSetup: nt(n) }),
            ...
            (e = t).ui.registry.addMenuItem('openlink', { text: 'Open link', icon: 'new-tab', onAction: Y(e), onSetup: nt(e) }),
            e.ui.registry.addMenuItem('link', { icon: 'link', text: 'Link...', shortcut: 'Meta+K', onAction: Q(e) }),
            ...
            (a = t).ui.registry.addContextForm('quicklink', {
                launch: { type: 'contextformtogglebutton', icon: 'link', tooltip: 'Link', onSetup: tt(a) },
                label: 'Link',
                ...
                commands: [
                    {
                        ...
                        onAction: function (t) {
                            ...
                            q(a, { href: n, attach: h }, { href: n, text: e, title: it.none(), rel: it.none(), target: it.none(), class: it.none() }), a.selection.collapse(!1), t.hide()
                        },
                    },
                    {
            ...
            (o = t).addCommand('mceLink', function () {
                o.getParam('link_quicklink', !1, 'boolean') ? o.fire('contexttoolbar-show', { toolbarKey: 'quicklink' }) : Q(o)()
            }),
