...
!(function () {
            ...
            ? ((r = !0 === t ? 'p' : t),
              ...
              (i = (function (e, t) {
                  var n,
                      ...
                      a = '<' + e
                  if ('object' == typeof t) {
                      for (var o in t) (n = o), be.call(t, n) && r.push(o + '="' + xe.encodeAllRaw(t[o]) + '"')
                      r.length && (a += ' ' + r.join(' '))
                  }
                  return a + '>'
              })(r, a)),
    ...
    function O(r, e) {
        ...
        i.addAttributeFilter('style', function (e) {
                ...
                (t = e[n]).attr(
                    ...
                    (function (r, a, o, i) {
                        ...
                        return (
                            ...
                            /(bold)/i.test(s['font-weight']) && (delete s['font-weight'], o.wrap(new _e('b', 1))),
                            /(italic)/i.test(s['font-style']) && (delete s['font-style'], o.wrap(new _e('i', 1))),
            ...
            i.addNodeFilter('a', function (e) {
                for (var t, n, r, a = e.length; a--; ) (n = (t = e[a]).attr('href')), (r = t.attr('name')), n && -1 !== n.indexOf('#_msocom_') ? t.remove() : (!(n = n && 0 === n.indexOf('file://') ? (n = n.split('#')[1]) && '#' + n : n) && !r) || (r && !/^_?(?:toc|edn|ftn)/i.test(r)) ? t.unwrap() : t.attr({ href: n, name: r })
            })
        var s = i.parse(e)
        return (
                    ...
                    for (
                        var a,
                            ...
                            t = function (e, t, n) {
                                ...
                                ;(a = r !== i ? (r < i ? a && a.parent.parent : ((o = a), null)) : a) && a.name === t ? a.append(e) : ((o = o || a), (a = new _e(t, 1)), 1 < n && a.attr('start', '' + n), e.wrap(a)), (e.name = 'li'), i < r && o && o.lastChild.append(a), (i = r), l(e), s(e, /^\u00a0+/), s(e, /^\s*([\u2022\u00b7\u00a7\u25CF]|\w+\.)/), s(e, /^\u00a0+/)
                            },
                            r = [],
                            u = e.firstChild;
                        null != u;
                        ...
                        if ((r.push(u), null !== (u = u.walk()))) for (; void 0 !== u && u.parent !== e; ) u = u.walk()
                            ...
                            ? ((c = n(e)),
                              /^[\s\u00a0]*[\u2022\u00b7\u00a7\u25CF]\s*/.test(c)
                                  ...
                                  : (function (t) {
                                        ...
                                        return (
                                            (t = c.replace(/^[\u00a0 ]+/, '')),
                                            ge.each([/^[IVXLMCD]+\.[ \u00a0]/, /^[ivxlmcd]+\.[ \u00a0]/, /^[a-z]{1,2}[\.\)][ \u00a0]/, /^[A-Z]{1,2}[\.\)][ \u00a0]/, /^[0-9]+\.[ \u00a0]/, /^[\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d]+\.[ \u00a0]/, /^[\u58f1\u5f10\u53c2\u56db\u4f0d\u516d\u4e03\u516b\u4e5d\u62fe]+\.[ \u00a0]/], function (e) {
                                                if (e.test(t)) return !(n = !0)
                                            }),
                                            n
                                        )
                                    })(c)
                                  ? ((d = 1), t(e, 'ol', (d = (f = /([0-9]+)\./.exec(c)) ? parseInt(f[1], 10) : d)))
                                  : e._listLevel
                                  ? t(e, 'ul', 1)
                                  : (a = null))
                            : ((o = a), (a = null))
    ...
    function j(e, t, n) {
        ...
        return (
            (i = n),
            (s = g),
            (m = (o = e).fire('PastePreProcess', { content: v, internal: i, wordContent: s })),
            (p = (function (e, t) {
                var n = Pe({}, e.schema)
            ...
            o.hasEventListeners('PastePostProcess') && !m.isDefaultPrevented() ? ((u = i), (c = s), (f = (l = o).dom.create('div', { style: 'display:none' }, p)), S((d = l.fire('PastePostProcess', { node: f, internal: u, wordContent: c })).node.innerHTML, d.isDefaultPrevented())) : S(p, m.isDefaultPrevented())
        )
    }
    function R(e, t) {
            ...
            u = b(
                ...
                (s = {
                    pcIsSpace: !(a = function (e, t) {
                        return -1 !== ' \f\t\v'.indexOf(t) || '\xa0' === t ? (e.pcIsSpace || '' === e.str || e.str.length === i.length - 1 || ((n = e.str.length + 1) < i.length && 0 <= n && E(i[n])) ? { pcIsSpace: !1, str: e.str + '\xa0' } : { pcIsSpace: !0, str: e.str + ' ' }) : { pcIsSpace: E(t), str: e.str + t }
                        var n
                    }),
                    str: '',
                }),
                ...
                (function (e, t) {
                    ...
                    function (r) {
                        return (
                            d(r.type, 'image/', 0) &&
                            u(i, function (e) {
                                return (t = e.toLowerCase()), (ge.hasOwn((n = { jpg: 'jpeg', jpe: 'jpeg', jfi: 'jpeg', jif: 'jpeg', jfif: 'jpeg', pjpeg: 'jpeg', pjp: 'jpeg', svg: 'svg+xml' }), t) ? 'image/' + n[t] : 'image/' + t) === r.type
                                var t, n
                            })
                        )
                    })
                        ...
                        .then(function (e) {
                            t && P.selection.setRng(t),
                                f(e, function (e) {
                                    ...
                                    ;(t = P),
                                        (r = (n = e).uri),
                                        (g = (a = /data:([^;]+);base64,([a-z0-9\+\/=]+)/i.exec(r)) ? { type: a[1], data: decodeURIComponent(a[2]) } : { type: null, data: null }),
                                        (v = g.data),
                                        (h = g.type),
                                        (y = Te()),
                                        (b = n.blob),
                                        ...
                                        !(p = t.getParam('images_dataimg_filter')) || p(m)
                                            ? ((c = void 0),
                                              (i = (o = t.editorUpload.blobCache).getByData(v, h)) ? (c = i) : ((l = (s = t.getParam('images_reuse_filename') && w(b.name)) ? ((f = t), w((d = b.name.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i))) ? f.dom.encode(d[1]) : null) : y), (u = s ? b.name : void 0), (c = o.create(y, b, v, l, u)), o.add(c)),
                ...
                (o =
                    H(t, 'text/plain') && p
                        ...
                        : ((i = o),
                          ...
                          (f = ge.makeMap('script noscript style textarea video audio iframe object', ' ')),
                              ...
                              if ('br' !== t) {
                                  if ('wbr' !== t)
                                      if ((c[t] && (u += ' '), f[t])) u += ' '
                                          ...
                                          if ((3 === e.type && (u += e.value), !e.shortEnded && (e = e.firstChild))) for (; m(e), (e = e.next); );
                                          d[t] && n.next && ((u += '\n'), 'p' === t && (u += '\n'))
                                      }
                              } else u += '\n'
                          }),
                          ...
                          m(l.parse(i)),
                          u)),
                v.isDefaultContent(o) ? n || e.windowManager.alert('Please use Ctrl+V/Cmd+V keyboard shortcuts to paste contents.') : r ? L(e, o) : B(e, o, a)
        }
        ;(s = o),
            (v = e),
            (l = t),
            ...
            s.on('keydown', function (e) {
                ...
                if (U(e) && !e.isDefaultPrevented() && (!(u = e.shiftKey && 86 === e.keyCode) || !fe.webkit || -1 === navigator.userAgent.indexOf('Version/'))) {
                    if ((e.stopImmediatePropagation(), c.set(e), f.set(!0), fe.ie && u)) return e.preventDefault(), void s.fire('paste', { ieFake: !0 })
                    v.remove(),
                        v.create(),
                        s.once('keyup', t),
            ...
            s.on('paste', function (e) {
                ...
                var n,
                    ...
                    o = H(r, ye())
                ;(u = !1),
                    e.isDefaultPrevented() || ((n = e.clipboardData), -1 !== navigator.userAgent.indexOf('Android') && n && n.items && 0 === n.items.length) || (!$(r) && z(s, e, v.getLastRng() || s.selection.getRng()))
                        ? v.remove()
                        : (t || e.preventDefault(),
                          !fe.ie ||
                              (t && !e.ieFake) ||
                          ...
                          H(r, 'text/html')
                              ? (e.preventDefault(), (o = o || y(r['text/html'])), d(s, r, t, a, o))
                              : de.setEditorTimeout(
                                    s,
                                    function () {
                                        d(s, r, t, a, o)
            ...
            o.parser.addNodeFilter('img', function (e, t, n) {
                var r
                if (!g(o) && n.data && !0 === n.data.paste) for (var a = e.length; a--; ) (i = e[a].attr('src')) && ((0 !== i.indexOf('webkit-fake-url') && (o.getParam('allow_html_data_urls', !1, 'boolean') || 0 !== i.indexOf('data:'))) || (r = e[a]).attr('data-mce-object') || i === fe.transparentSrc || r.remove())
            })
    }
    function K(e) {
            ...
            create: function () {
                return (function (e, t, n) {
                    ...
                    var o,
                        ...
                        s,
                        l,
                        u = e.dom.add(K(e), 'div', { id: 'mcepastebin', class: 'mce-pastebin', contentEditable: !0, 'data-mce-bogus': 'all', style: 'position: fixed; top: 50%; width: 10px; height: 10px; overflow: hidden; opacity: 0' }, n)
                    ;(fe.ie || fe.gecko) && r.setStyle(u, 'left', 'rtl' === r.getStyle(a, 'direction', !0) ? 65535 : -65535),
    ...
    function W(e, t, n, r) {
        !(function (e, t, n) {
            if (!1 === fe.iOS && 'function' == typeof (null == e ? void 0 : e.setData))
                try {
    ...
    function Y(s) {
        return function (e, t) {
            ...
            s.dom.setStyles(r, { position: 'fixed', top: '0', left: '-3000px', width: '1000px', overflow: 'hidden' }), r.appendChild(a), s.dom.add(s.getBody(), r)
    ...
    r.add('paste', function (e) {
        if (0 == (!!e.hasPlugin('powerpaste', !0) && (void 0 !== window.console && window.console.log && window.console.log("PowerPaste is incompatible with Paste plugin! Remove 'paste' from the 'plugins' option."), !0))) {
            ...
            return (
                ...
                (m = e).ui.registry.addToggleButton('pastetext', { active: !1, icon: 'paste-text', tooltip: 'Paste as text', onAction: x, onSetup: re(m, (p = r)) }),
                m.ui.registry.addToggleMenuItem('pastetext', { text: 'Paste as text', icon: 'paste-text', onAction: x, onSetup: re(m, p) }),
                (d = r),
                ...
                i.on('drop', function (e) {
                    ...
                    e.isDefaultPrevented() ||
                        ...
                        ((!s.hasHtmlOrText(t) || ((r = t['text/plain']) && 0 === r.indexOf('file://'))) && s.pasteImageData(e, o)) ||
                            !o ||
