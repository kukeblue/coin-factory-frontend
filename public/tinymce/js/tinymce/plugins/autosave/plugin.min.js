...
!(function () {
    ...
    function u(t) {
        ...
        return !(new Date().getTime() - e > o(t.getParam('autosave_retention'), '20m') && (g(t, !1), 1))
    }
    function s(t) {
        var e = n(t)
        !i(t) && t.isDirty() && (v.setItem(e + 'draft', t.getContent({ format: 'raw', no_events: !0 })), v.setItem(e + 'time', new Date().getTime().toString()), t.fire('StoreDraft'))
    }
    function f(t) {
        var e = n(t)
