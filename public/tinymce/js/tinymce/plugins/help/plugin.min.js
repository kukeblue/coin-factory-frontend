...
!(function () {
    ...
    function f(e) {
        var n = m.mac ? { alt: '&#x2325;', ctrl: '&#x2303;', shift: '&#x21E7;', meta: '&#x2318;', access: '&#x2303;&#x2325;' } : { meta: 'Ctrl ', access: 'Shift + Alt ' },
                    ...
                    html: [
                        null == e
                            ...
                            : '<div data-mce-tabstop="1" tabindex="-1">' +
                                  ...
                                  function (e) {
                                      return (
                                          ...
                                          (function (e, t, n) {
                                              ...
                                              function (e) {
                                                  return a({ name: e.name, url: 'https://www.tiny.cloud/docs/plugins/' + e.type + '/' + e.slug })
                                              }
                                          )) +
                                          '</li>'
                                      )
                              ...
                              (l = s.length),
                              (c = s.join('')),
                              '<p><b>' + C.translate(['Plugins installed ({0}):', l]) + '</b></p><ul>' + c + '</ul>') +
                              '</div>',
                        ((t = b(['Accessibility Checker', 'Advanced Code Editor', 'Advanced Tables', 'Case Change', 'Checklist', 'Export', 'Tiny Comments', 'Tiny Drive', 'Enhanced Media Embed', 'Format Painter', 'Link Checker', 'Mentions', 'MoxieManager', 'Page Embed', 'Permanent Pen', 'PowerPaste', 'Spell Checker Pro'], function (e) {
                            return '<li>' + C.translate(e) + '</li>'
                        }).join('')),
                        '<div data-mce-tabstop="1" tabindex="-1"><p><b>' + C.translate('Premium plugins:') + '</b></p><ul>' + t + '<li class="tox-help__more-link" "><a href="https://www.tiny.cloud/pricing/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">' + C.translate('Learn more...') + '</a></li></ul></div>'),
                    ].join(''),
                },
            ],
        }
        ...
        return function () {
            var e,
                ...
                h =
                    ...
                    (c = { name: 'versions', title: 'Version', items: [{ type: 'htmlpanel', html: '<p>' + C.translate(['You are using {0}', '<a href="https://www.tiny.cloud/docs/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">TinyMCE ' + i + '</a>']) + '</p>', presets: 'document' }] }),
                    (u = y((((n = {})[r.name] = r), (n[s.name] = s), (n[l.name] = l), (n[c.name] = c), n), t.get())),
                    v.from(e.getParam('help_tabs')).fold(
                        function () {
                            return -1 !== (n = (t = w((e = u))).indexOf('versions')) && (t.splice(n, 1), t.push('versions')), { tabs: e, names: t }
                            var e, t, n
                        },
                        function (e) {
                            return (
                                ...
                                (n = {}),
                                (a = b(e, function (e) {
                                    return 'string' == typeof e ? (A(t, e) && (n[e] = t[e]), e) : (n[e.name] = e).name
                                })),
                                { tabs: n, names: a }
                            )
                            var t, n, a
            ...
            d.windowManager.open({ title: 'Help', size: 'medium', body: { type: 'tabpanel', tabs: p }, buttons: [{ type: 'cancel', name: 'close', text: 'Close', primary: !0 }], initialData: {} })
        }
    }
    var c = function (n) {
            function e() {
        ...
        d = b(
            [
                ...
                { key: 'tinycomments', name: 'Tiny Comments*', type: p, slug: 'comments' },
                { key: 'advtable', name: 'Advanced Tables*', type: p },
                { key: 'autocorrect', name: 'Autocorrect*', type: p },
                { key: 'export', name: 'Export*', type: p },
            ],
            function (e) {
                return y(y({}, e), { type: e.type || 'opensource', slug: e.slug || e.key })
            }
        ),
    ...
    n.add('help', function (e) {
        var t,
            ...
            r = l(e, (n = o)),
            s = r
        return (a = e).ui.registry.addButton('help', { icon: 'help', tooltip: 'Help', onAction: s }), a.ui.registry.addMenuItem('help', { text: 'Help', icon: 'help', shortcut: 'Alt+0', onAction: s }), e.addCommand('mceHelp', r), e.shortcuts.add('Alt+0', 'Open help dialog', 'mceHelp'), i
    })
})()
