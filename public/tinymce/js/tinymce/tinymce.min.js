...
!(function () {
    ...
    var Ke = function (e, t) {
        ...
        et = {
            browsers: J([
                ...
                { name: 'Opera', versionRegexes: [Ze, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Pe('opera') },
                { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: Pe('firefox') },
                {
                    name: 'Safari',
            ...
            oses: J([
                { name: 'Windows', search: Pe('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
                {
                    name: 'iOS',
                    search: function (e) {
                ...
                { name: 'Android', search: Pe('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
                { name: 'OSX', search: Pe('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
                ...
                { name: 'ChromeOS', search: Pe('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
            ]),
        },
        tt = 'Firefox',
        nt = function () {
                            ...
                            return (
                                ...
                                G(e.brands, function (t) {
                                    ...
                                    return I(r, function (e) {
                                        ...
                                        return { current: e.name, version: Xe.nu(parseInt(t.version, 10), 0) }
                                    })
                                })
                            )
                            var r
        ...
        Ct = {
            ...
            windowsPhone: yt,
            browser: { current: gt.current, version: gt.version, isChrome: gt.isChrome, isEdge: gt.isEdge, isFirefox: gt.isFirefox, isIE: gt.isIE, isOpera: gt.isOpera, isSafari: gt.isSafari },
            os: { current: pt.current, version: pt.version, isAndroid: pt.isAndroid, isChromeOS: pt.isChromeOS, isFreeBSD: pt.isFreeBSD, isiOS: pt.isiOS, isLinux: pt.isLinux, isOSX: pt.isOSX, isSolaris: pt.isSolaris, isWindows: pt.isWindows },
            deviceType: { isDesktop: ht.isDesktop, isiPad: ht.isiPad, isiPhone: ht.isiPhone, isPhone: ht.isPhone, isTablet: ht.isTablet, isTouch: ht.isTouch, isWebView: ht.isWebView },
        },
        wt = /^\s*|\s*$/g,
        xt = function (e, n, r, o) {
            ;(o = o || this),
    ...
    ;(Nn = nr),
        ...
        (_n = void 0),
        (function (e) {
            'object' == typeof Nn && void 0 !== kn ? (kn.exports = e()) : (('undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this).EphoxContactWrapper = e())
        })(function () {
    ...
    function Mr(m, g) {
        function n(e, t, n) {
            ...
            t && i.passed.push(t),
                n && i.failed.push(n),
                1 !== i.status &&
                    (2 !== i.status ? (3 !== i.status ? ((i.status = 1), pn((c = Et.fromTag('link', b.dom)), { rel: 'stylesheet', type: 'text/css', id: i.id }), (l = Date.now()), g.contentCssCors && gn(c, 'crossOrigin', 'anonymous'), g.referrerPolicy && gn(c, 'referrerpolicy', g.referrerPolicy), ((r = c.dom).onload = d), (r.onerror = s), (f = c), In(jt(v), f), gn(c, 'href', o)) : s()) : u())
        }
        function o(t) {
    ...
    function uo(e, t) {
        var n,
            ...
            i = {}
        if (e) {
            for (e = e.split(','), t = t || 10, n = 0; n < e.length; n += 2) (r = String.fromCharCode(parseInt(e[n], t))), ii[r] || ((o = '&' + e[n + 1] + ';'), (i[r] = o), (i[o] = r))
            return i
        }
    }
    function so(e, t) {
    ...
    function go(i) {
        ...
        var t,
            ...
            m =
                ...
                ci[t] ||
                    ...
                    'html4' !== t && ((s += ' contenteditable contextmenu draggable dropzone hidden spellcheck translate'), (n += ' article aside details dialog figure main header footer hgroup section nav'), (r += ' audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen')),
                    'html5-strict' !== t &&
                        ((s += ' xml:lang'),
                    ...
                    'html4' !== t && (p('input button select textarea', 'autofocus'), p('input textarea', 'placeholder'), p('a', 'download'), p('link script img', 'crossorigin'), p('img', 'loading'), p('iframe', 'sandbox seamless allowfullscreen loading')),
        ...
        function p(e, t) {
            for (var n, r, o, i = fo(e), a = i.length, u = fo(t); a--; ) for (n = c[i[a]], r = 0, o = u.length; r < o; r++) (n.attributes[u[r]] = {}), n.attributesOrder.push(u[r])
        }
                        ...
                        if (
                            ...
                            for (r = 0, o = (s = fo(s, '|')).length; r < o; r++)
                                (i = C.exec(s[r])) &&
                                    ...
                                    '-' !== f
                                        ? (g && ('=' === g && ((a.attributesDefault = a.attributesDefault || []), a.attributesDefault.push({ name: l, value: b }), (u.defaultValue = b)), ':' === g && ((a.attributesForced = a.attributesForced || []), a.attributesForced.push({ name: l, value: b }), (u.forcedValue = b)), '<' === g && (u.validValues = fi(b, '?'))),
            ...
            e &&
                ...
                di(fo(e, ','), function (e) {
                    ...
                    ;(l[i] = l[o]),
                        ...
                        S[i] || ((t = S[o]), delete (t = mi({}, t)).removeEmptyAttrs, delete t.removeEmpty, (S[i] = t)),
                        di(l, function (e, t) {
        ...
        di((i.special || 'script noscript iframe noframes noembed title style textarea xmp').split(' '), function (e) {
            ...
            L('+ol[ul|ol],+ul[ul|ol]'),
            di({ dd: 'dl', dt: 'dl', li: 'ul ol', td: 'tr', th: 'tr', tr: 'tbody thead tfoot', tbody: 'table', thead: 'table', tfoot: 'table', legend: 'fieldset', area: 'map', param: 'video audio object' }, function (e, t) {
                ...
                if (e) {
                    for (
                        ...
                        (x.lastIndex = s.index + s[0].length),
                            ...
                            (l = s[2].replace(S, '')),
                            c && l && ((c = i(c)), (l = i(l)), -1 === c.indexOf(N) && -1 === c.indexOf('"') && (b.allow_script_urls || ('behavior' !== c && !/expression\s*\(|\/\*|\*\//.test(l))) && ('font-weight' === c && '700' === l ? (l = 'bold') : ('color' !== c && 'background-color' !== c) || (l = l.toLowerCase()), (l = (l = l.replace(C, po)).replace(w, a)), (p[c] = f ? u(l, !0) : l)))
                    t('border', '', !0),
                        t('border', '-width'),
                        t('border', '-color'),
                        t('border', '-style'),
    ...
    function bo(e, t, n, r) {
        ...
        return (
            (a.type = e),
            re(a.target) && (a.target = null !== (o = a.srcElement) && void 0 !== o ? o : n),
            (re((i = t).preventDefault) || vo(i)) &&
                ...
                a.isDefaultPrevented !== x && a.isDefaultPrevented !== T && ((a.isDefaultPrevented = !0 === a.defaultPrevented ? x : T), (a.isPropagationStopped = !0 === a.cancelBubble ? x : T), (a.isImmediatePropagationStopped = T))),
            a
        )
    }
    function yo(e, t, n, r) {
    ...
    function wo(e, t) {
        ...
        return (
            V((i = e)) &&
                ...
                b(e.pageX) &&
                !b(e.clientX) &&
                ((r = (n = a.target.ownerDocument || document).documentElement), (o = n.body), (a.pageX = e.clientX + ((r && r.scrollLeft) || (o && o.scrollLeft) || 0) - ((r && r.clientLeft) || (o && o.clientLeft) || 0)), (a.pageY = e.clientY + ((r && r.scrollTop) || (o && o.scrollTop) || 0) - ((r && r.clientTop) || (o && o.clientTop) || 0))),
    ...
    var xo = Vr(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']),
        ...
        Qo = function (e, t, n) {
            ...
            for (var o, i, a, u, s, c, l, f, d, m, g, p = t.childNodes, h = p.length - 1; 0 <= h; h--) Qo(e, p[h], r)
        ...
        bi =
                                            ...
                                            ? (function (e, t, n) {
                                                  ...
                                                  n.domLoaded
                                                      ...
                                                      : ((r = function () {
                                                        ...
                                                        'complete' === o.readyState || ('interactive' === o.readyState && o.body) ? r() : yo(e, 'DOMContentLoaded', r),
            ...
            (yi.prototype.fire = function (e, t, n) {
                ...
                for (var o = wo({ type: t, target: e }, n); (r = e[this.expando]) && this.executeHandlers(o, r), (e = e.parentNode || e.ownerDocument || e.defaultView || e.parentWindow) && !o.isPropagationStopped(); );
                return this
            }),
    ...
    ;(wi = ba.support = {}),
                ...
                return s !== Oi && 9 === s.nodeType && s.documentElement
                    ? ((Bi = (Oi = s).documentElement),
                      ...
                      (xi.find.TAG = wi.getElementsByTagName
                          ? function (e, t) {
                                if (typeof t.getElementsByTagName != Wi) return t.getElementsByTagName(e)
                            }
                          : function (e, t) {
                                var n,
                                    r = [],
                          ...
                          ? function (e, t) {
                                return e === t
                                    ...
                                    : (n = !e.compareDocumentPosition - !t.compareDocumentPosition) ||
                                          (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!wi.sortDetached && t.compareDocumentPosition(e) === n) ? (e === s || (e.ownerDocument === Ui && Mi(Ui, e)) ? -1 : t === s || (t.ownerDocument === Ui && Mi(Ui, t)) ? 1 : Ti ? Zi.call(Ti, e) - Zi.call(Ti, t) : 0) : 4 & n ? -1 : 1)
                                var n
                            }
                          : function (e, t) {
        ...
        (ba.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== Oi && Di(e), (t = t.replace(ua, "='$1']")), wi.matchesSelector && Pi && (!Ii || !Ii.test(t)) && (!Li || !Li.test(t))))
                try {
                    ...
                    CLASS: function (e) {
                        ...
                        return (
                            ...
                            ((t = new RegExp('(^|' + ea + ')' + e + '(' + ea + '|$)')) &&
                                Hi(e, function (e) {
                                    return t.test(('string' == typeof e.className && e.className) || (typeof e.getAttribute != Wi && e.getAttribute('class')) || '')
                                }))
                        )
                    },
                    ATTR: function (n, r, o) {
                        ...
                        return 1 === g && 0 === p
                            ...
                            : function (e, t, n) {
                                  ...
                                  if (l) {
                                      ...
                                      else for (; (i = (++u && i && i[c]) || (a = u = 0) || s.pop()) && ((b ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Fi] || (i[Fi] = {}))[m] = [zi, a]), i !== e)); );
                        ...
                        return a[Fi]
                            ...
                            ? ((t = [e, e, '', i]),
                              xi.setFilters.hasOwnProperty(e.toLowerCase())
                                  ? Ca(function (e, t) {
                                        for (var n, r = a(e, i), o = r.length; o--; ) e[(n = Zi.call(e, r[o]))] = !(t[n] = r[o])
                                    })
                                  : function (e) {
                                        return a(e, 0, t)
                                    })
        ...
        (Ni = ba.tokenize =
            function (e, t) {
                ...
                for (a = e, u = [], s = xi.preFilter; a; ) {
                    for (i in ((n && !(r = ia.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))), (n = !1), (r = aa.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(oa, ' ') }), (a = a.slice(n.length))), xi.filter))
                        xi.filter.hasOwnProperty(i) && (!(r = la[i].exec(a)) || (s[i] && !(r = s[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length))))
                    if (!n) break
                }
                                                ...
                                                Ca(function (e, t, n, r) {
                                                    var o,
                                                        ...
                                                        l =
                                                            e ||
                                                            (function (e, t, n) {
                                                                for (var r = 0, o = t.length; r < o; r++) ba(e, t[r], n)
                                                                return n
                                                            })(g || '*', n.nodeType ? [n] : n, []),
                                                        f = !m || (!e && g) ? l : Aa(l, u, m, n, r),
                                                        d = p ? (v || (e ? m : c || h) ? [] : t) : f
                                                    if ((p && p(f, d, n, r), h)) for (o = Aa(d, s), h(o, [], n, r), i = o.length; i--; ) (a = o[i]) && (d[s[i]] = !(f[s[i]] = a))
                                                    if (e) {
                                                        if (v || m) {
                                                            if (v) {
    ...
    var Fa = document,
        ...
        qa = function (e, t, n, r) {
            ...
            if (Ra(t)) t = Da(t, Qa(e[0]))
                ...
                if (((t = ou.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) qa(e, t[o], n, r)
    ...
    ;(Pa.fn = Pa.prototype =
        {
            ...
            init: function (e, t) {
                ...
                if (Ra(e)) {
                    ...
                    if (n[1]) for (r = Da(e, Qa(t)).firstChild; r; ) Ua.call(o, r), (r = r.nextSibling)
                    else {
            ...
            remove: function () {
                for (var e, t = this.length; t--; ) (e = this[t]), Ha.clean(e), e.parentNode && e.parentNode.removeChild(e)
                return this
            },
            empty: function () {
            ...
            find: function (e) {
                for (var t = [], n = 0, r = this.length; n < r; n++) ou.find(e, this[n], t)
                return ou(t)
            },
            filter: function (n) {
                return ou(
            ...
            var _,
                ...
                $ = {
                    ...
                    createHTML: function (e, t, n) {
                        var r,
                            o = ''
                        for (r in ((o += '<' + e), t)) ue(t, r) && (o += ' ' + r + '="' + H(t[r]) + '"')
                ...
                W =
                    ...
                    (t = {
                        style: {
                            set: function (e, t) {
                                null === t || 'object' != typeof t ? (R && e.attr('data-mce-style', t), null !== t && 'string' == typeof t ? (e.removeAttr('style'), e.css(_.parse(t))) : e.attr('style', t)) : e.css(t)
                            },
                            get: function (e) {
        ...
        Cu = function () {
            ...
            var o = [],
                ...
                d = function (r, o, i, a, e) {
                    var t, n
                    l[r] ||
                        (0 !== (t = 'string' == typeof o ? o : o.prefix + o.resource + o.suffix).indexOf('/') && -1 === t.indexOf('://') && (t = Cu.baseURL + '/' + t),
    ...
    function Fu(e) {
        return e ? { left: is(e.left), top: is(e.top), bottom: is(e.bottom), right: is(e.right), width: is(e.width), height: is(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 }
    }
    function Uu(e, t) {
        ...
        for (
            qn(a)
                ? s.push(
                      n
                          ? (function (e, t, n) {
                                for (var r = e(t.data.slice(0, n)).length, o = t.previousSibling; o && qn(o); o = o.previousSibling) r += e(o.data).length
                                return r
                            })(t, a, u)
                          : u
                  )
            ...
            show: function (e, t) {
                ...
                if (!a(t))
                    return (
                        ...
                        Pc(l.nextSibling) ? (n.setStart(l, 0), n.setEnd(l, 0)) : (n.setStart(l, 1), n.setEnd(l, 1)),
                        n
                    )
                l = (function (e, t, n) {
                    var r,
    ...
    function al(t, e) {
        !(function (e, t) {
            ...
            if (t) {
                ...
                if (Ee(t, 'id'))
                    return fn((a = il((o = g), 'start', (i = t))), il(o, 'end', i).or(a), function (e, t) {
                        var n = o.createRng()
    ...
    function fl(e, t, n) {
        ...
        if ((i !== n.endContainer || !(r = i.childNodes[o]) || !/^(IMG)$/.test(r.nodeName)) && Hn(i)) {
            ...
            for (var s = u.current(); s; s = u.next()) if (qn(s) && !bf(s)) return n.setStart(s, 0), t.setRng(n), 0
        }
    }
    function dl(e, t, n) {
        if (e) {
    ...
    function Rl(i, e, t, n, a, r) {
        ...
        return o(t, n, Al)
            ...
            .orThunk(function () {
                return u ? he.some({ container: u, offset: a ? 0 : u.length }) : he.none()
            })
    }
    ...
    function Ll(e, t, n, r) {
        ...
        return (
            ...
            Hn(a) && a.hasChildNodes() && ((a = $u(a, t.collapsed ? u : u - 1)), qn(a) && (u = a.nodeValue.length)),
            (o = kl(s, o)),
            (a = kl(s, a)),
            Pl(o) && ((o = yf(o) ? o : o.parentNode), (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o), qn(o) && (i = t.collapsed ? o.length : 0)),
            Pl(a) && ((a = yf(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), qn(a) && (u = t.collapsed ? 0 : a.length)),
            t.collapsed &&
            ...
            (El(c) || c.block_expand) && ((El(c) && qn(o) && 0 !== i) || (o = Bl(s, n, o, i, !0)), (El(c) && qn(a) && u !== a.nodeValue.length) || (a = Bl(s, n, a, u, !1))),
            Nl(c) && ((o = Dl(s, n, t, o, 'previousSibling')), (a = Dl(s, n, t, a, 'nextSibling'))),
            (xl(c) || Sl(c)) && ((o = Ol(e, n, o, 'previousSibling')), (a = Ol(e, n, a, 'nextSibling')), xl(c) && (s.isBlock(o) || (o = Bl(s, n, o, i, !0)), s.isBlock(a) || (a = Bl(s, n, a, u, !1)))),
                    ...
                    ;(s = t),
                        ...
                        (u = o).undoManager.transact(function () {
                            var e,
                                ...
                                i = o.getRng(),
                                a = 0 < Ul(u).length
                            i.collapsed && !a && ((n = Ll((e = u), (t = i), [{ inline: 'span' }])), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)),
                                o.getRng().collapsed && !a
                                    ? (Ou((r = Kl(u.getDoc(), l, s, c.decorate)), Do), o.getRng().insertNode(r.dom), o.select(r.dom))
                                    : $l(o, !1, function () {
                                          ql(u, function (e) {
    ...
    var Ql,
        ...
        pf = '_mce_caret',
        hf = function (e, t, n) {
            return 2 === t ? Rs(Po, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: Ss(r.dom.getRoot(), bs.fromRangeStart(o)), end: Ss(r.dom.getRoot(), bs.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : Os(e, !1)
            var r, o
        },
        vf =
            ((Ql = Do),
    ...
    function Of(r, l) {
        ...
        function g(e) {
            ...
            ;(k = u * b[2] + x),
                ...
                (k = k < 5 ? 5 : k),
                (_ = _ < 5 ? 5 : _),
                ((c(p) || f(p)) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean') ? !$f.modifierPressed(e) : $f.modifierPressed(e)) && (L(u) > L(s) ? ((_ = I(k * E)), (k = I(_ / E))) : ((k = I(_ / E)), (_ = I(k * E)))),
                m(h, k, _),
                (t = b.startPos.x + u),
                (n = b.startPos.y + s),
                D.setStyles(v, { left: (t = 0 < t ? t : 0), top: (n = 0 < n ? n : 0), display: 'block' }),
                (v.innerHTML = k + ' &times; ' + _),
                b[2] < 0 && h.clientWidth <= k && D.setStyle(h, 'left', void 0 + (x - k)),
                b[3] < 0 && h.clientHeight <= _ && D.setStyle(h, 'top', void 0 + (S - _)),
                (u = M.scrollWidth - A) + (s = M.scrollHeight - T) != 0 && D.setStyles(v, { left: t - u, top: n - s }),
                N || ((r = p), (o = x), (i = S), (a = 'corner-' + b.name), l.fire('ObjectResizeStart', { target: r, width: o, height: i, origin: a }), (N = !0))
        }
        function o(e) {
            function t(e, t) {
                if (e)
            ...
            N ||
                l.removed ||
                (O(D.select('img[data-mce-selected],hr[data-mce-selected]'), function (e) {
                    e.removeAttribute(R)
                }),
                (n = 'mousedown' === e.type ? e.target : r.getNode()),
                t((n = D.$(n).closest('table,img,figure.image,hr,video,span.mce-preview-object')[0]), M) && (s(), t(r.getStart(!0), n) && t(r.getEnd(!0), n)) ? z(n) : j())
        }
        function u(e) {
        ...
        var p,
            ...
            U = function () {
                ...
                ;(N = !1),
                    ...
                    D.remove(y),
                    z(p),
                    o && ((e = p), (t = k), (n = _), (r = 'corner-' + b.name), l.fire('ObjectResized', { target: e, width: t, height: n, origin: r }), D.setAttrib(p, 'style', D.getAttrib(p, 'style'))),
                    l.nodeChanged()
            },
            z = function (e) {
                H()
                ...
                i(e) && !r.isDefaultPrevented()
                    ? O(F, function (o, i) {
                          ...
                          e && D.remove(e),
                              (e = D.add(M, 'div', { id: 'mceResizeHandle' + i, 'data-mce-bogus': 'all', class: 'mce-resizehandle', unselectable: !0, style: 'cursor:' + i + '-resize; margin:0; padding:0' })),
                              ...
                              D.bind(e, 'mousedown', function (e) {
                                  ...
                                  e.stopImmediatePropagation(),
                                      ...
                                      D.setStyles(y, { position: 'fixed', left: '0', top: '0', width: '100%', height: '100%' }),
                                      (h = f((n = p)) ? D.create('img', { src: Ct.transparentSrc }) : n.cloneNode(!0)),
                                      ...
                                      D.bind(B, 'mouseup', U),
                                      P !== B && (D.bind(P, 'mousemove', g), D.bind(P, 'mouseup', U)),
                                      (v = D.add(M, 'div', { class: 'mce-resize-helper', 'data-mce-bogus': 'all' }, x + ' &times; ' + S))
                              }),
                              (o.elm = e),
                              D.setStyles(e, { left: s * o[0] + a - e.offsetWidth / 2, top: c * o[1] + u - e.offsetHeight / 2 })
                      })
                    : j(),
    ...
    function Ff(e, t, n) {
        for (var r = new jr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot()); (t = r[n ? 'prev' : 'next']()); ) if (Xn(t)) return 1
    }
    ...
    function Vf(e) {
        var t = e.startContainer,
            ...
            o = e.endOffset
        return (
            t === r && qn(t) ? 0 < n && n < t.nodeValue.length && ((t = (r = Hf(t, n)).previousSibling), n < o ? ((t = r = Hf(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0)) : (qn(t) && 0 < n && n < t.nodeValue.length && ((t = Hf(t, n)), (n = 0)), qn(r) && 0 < o && o < r.nodeValue.length && (o = (r = Hf(r, o).previousSibling).nodeValue.length)),
                ...
                ((Md = function (e) {
                    ...
                    t &&
                        !(function (e) {
                            ...
                            e.ownerDocument === document && (e === document.body || Ed(t, e) || n.focusedEditor !== t || (t.fire('blur', { focusedEditor: null }), (n.focusedEditor = null)))
                        })
                }),
    ...
    function _d(t, e) {
        ...
        ;(n = Et.fromDom(t.getBody())),
            ((r = e).collapsed ? he.from($u(r.startContainer, r.startOffset)).map(Et.fromDom) : he.none())
                .bind(function (e) {
    ...
    function Bd(e, t) {
        for (var n = e; e && qn(e) && 0 === e.length; ) e = t ? e.nextSibling : e.previousSibling
        return e || n
    }
    function Pd(n, e) {
        return R(e, function (e) {
    ...
    var Md,
            ...
            var a,
                ...
                l =
                    ...
                    (s = (function (e, t) {
                        ...
                        var r = n[n.length - 1]
                        return Qf(r) ? { element: e, offset: t } : 'img' === Nt(r) ? { element: r, offset: 1 } : Tn(r) ? { element: r, offset: Wl(r).length } : { element: r, offset: On(r).length }
                    })(a, u)),
        ...
        Jd =
            ...
            (Qd.prototype.getAll = function (e) {
                for (var t = [], n = this.firstChild; n; n = Ld(n, this)) n.name === e && t.push(n)
                return t
            }),
        ...
        function n(m, e) {
            ...
            for (
                var t,
                    ...
                    E = 0,
                    N = si.decode,
                    k = St.makeMap('src,href,data,background,action,formaction,poster,xlink:href'),
                    ...
                    P = new RegExp('<(?:(?:!--([\\w\\W]*?)--!?>)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:![Dd][Oo][Cc][Tt][Yy][Pp][Ee]([\\w\\W]*?)>)|(?:!(--)?)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_:.]*)(\\s(?:[^\'">]+(?:"[^"]*"|\'[^\']*\'))*[^"\'>]*(?:"[^">]*|\'[^\'>]*)?|\\s*|\\/)>))', 'g'),
                    L = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g,
                ...
                if ((x < t.index && R(N(w.substr(x, t.index - x))), (i = t[7]))) T((i = ':' === (i = i.toLowerCase()).charAt(0) ? i.substr(1) : i))
                    ...
                    if (!U || (s = K.getElementRule(i))) {
                        if (
                            ...
                            if (((d = s.attributesRequired), (b = s.attributesDefault), (y = s.attributesForced), s.removeEmptyAttrs && !g.length && (c = !1), y)) for (r = y.length; r--; ) (a = (l = y[r]).name), '{$uid}' === (C = l.value) && (C = 'mce_' + E++), (g.map[a] = C), g.push({ name: a, value: C })
                            if (b) for (r = b.length; r--; ) (a = (l = b[r]).name) in g.map || ('{$uid}' === (C = l.value) && (C = 'mce_' + E++), (g.map[a] = C), g.push({ name: a, value: C }))
                            if (d) {
        ...
        return he
            ...
            .bind(function (e) {
                ...
                return (!Um(d, 0) || Fm(f, m)
                    ...
                    : ((i.data = ' ' + d.slice(1)), 1)) || ((t = g), (r = (n = l).data), (o = bs(n, r.length - 1)), Um(r, r.length - 1) && !Fm(t, o) && ((n.data = r.slice(0, -1) + ' '), 1))
                    ? he.some(e)
                    : he.none()
            })
    }
        ...
        0 !== n &&
            ...
            e.replaceData(
                ...
                P(
                    (s = i),
                    function (e, t) {
                        return sl(t) || vf(t) ? (e.previousCharIsSpace || ('' === e.str && c) || (e.str.length === s.length - 1 && l) ? { previousCharIsSpace: !1, str: e.str + Do } : { previousCharIsSpace: !0, str: e.str + ' ' }) : { previousCharIsSpace: !1, str: e.str + t }
                    },
                ...
                : sg(y, (i = C), (a = t), b)
                      ...
                      .bind(function (e) {
                          ...
                          if (0 < n.length) {
                              ...
                              var r = fg(a, i)
                              return he.some(gp.partialTable(n, he.some(ke(ke({}, i), { rng: r }))))
                          }
                          return he.none()
                      })
        )
    ...
    function Tg(e, t, n) {
        ...
        if (m.isDefaultPrevented()) e.fire('SetContent', { content: m.content, format: 'html', selection: !0, paste: n.paste })
            ...
            var g,
                ...
                v = e.getBody()
            h === v && u.isCollapsed() && s.isBlock(v.firstChild) && (p = v.firstChild) && !e.schema.getShortEndedElements()[p.nodeName] && s.isEmpty(v.firstChild) && ((g = s.createRng()).setStart(v.firstChild, 0), g.setEnd(v.firstChild, 0), u.setRng(g)),
                u.isCollapsed() ||
                    (function (e) {
                        var t = e.dom,
            ...
            ;(E = l),
                ...
                (function (n, e) {
                    ...
                    if (e) {
                        o.scrollIntoView(e)
                        var i = (function (e) {
                            for (var t = n.getBody(); e && e !== t; e = e.parentNode) if ('false' === r.getContentEditable(e)) return e
                            return null
                        })(e)
    ...
    function Og(u, s, e) {
        var c = e.no_events ? e : u.fire('BeforeSetContent', ke(ke({ format: 'html' }, e), { set: !0, content: Rg(s) ? '' : s }))
        return (
            Rg(s) || (s = c.content),
                ...
                return Rg(s)
                    ...
                    : ((t = u),
                      ...
                      0 === (r = s).length || /^\s+$/.test(r)
                          ? ((i = '<br data-mce-bogus="1">'), 'TABLE' === n.nodeName ? (r = '<tr><td>' + i + '</td></tr>') : /^(UL|OL)$/.test(n.nodeName) && (r = '<li>' + i + '</li>'), (r = (a = Ls(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), a.toLowerCase()) ? ((r = i), t.dom.createHTML(a, Is(t), r)) : r || '<br data-mce-bogus="1">'), Dg(t, r, o.no_selection), t.fire('SetContent', o))
                          : ('raw' !== o.format && (r = sm({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))), (o.content = To(Et.fromDom(n)) ? r : St.trim(r)), Dg(t, o.content, o.no_selection), o.no_events || t.fire('SetContent', o)),
                      o.content)
                var t, n, r, o, i, a
            })
        )
    ...
    function Fg(e, t, n, r, o, i) {
        ...
        if (a)
            ...
            } else for (var f = 0; f < a.length; f++) if ('attributes' === r ? e.getAttrib(t, a[f]) : bl(e, t, a[f])) return 1
        return 1
    }
    ...
    function Hg(e) {
        ...
        return pn(t, { id: Sp, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }), e && In(t, Et.fromText(xp)), t
    }
    function Vg(e, t, n) {
        void 0 === n && (n = !0)
        var r,
        ...
        zg(t)
            ...
            : ((r = d.getRng()), (o = f.getParent(t, f.isBlock)), (i = r.startContainer), (a = r.startOffset), (u = r.endContainer), (s = r.endOffset), (l = jg(t)) && l.nodeValue.charAt(0) === xp && l.deleteData(0, 1), (c = l), f.remove(t, !0), i === c && 0 < a && r.setStart(c, a - 1), u === c && 0 < s && r.setEnd(c, s - 1), o && f.isEmpty(o) && ym(Et.fromDom(o)), d.setRng(r))
    }
    function qg(e, t, n) {
        void 0 === n && (n = !0)
        var r = e.dom,
            o = e.selection
        if (t) Vg(e, t, n)
        else if (!(t = Zc(e.getBody(), o.getStart()))) for (; (t = r.get(Sp)); ) Vg(e, t, !1)
    }
    function $g(e, t) {
    ...
    function Xg(e, t, n, r) {
        ...
        i &&
            (o
                ? ((a = C.getBookmark()), x.collapse(!0), (u = Vf(Ll(e, x, e.formatter.get(t), !0))), e.formatter.remove(t, n, u, r), C.moveToBookmark(a))
                : ((s = Zc(e.getBody(), i)),
                  (d = c = Hg(!1).dom),
                  (p = (g = e.dom).getParent((m = null !== s ? s : i), A(ml, e))) && g.isEmpty(p)
            ...
            if (i && t)
                for (var u = 0; u < i.length; u++) {
                    ...
                    if (Mg(e.dom, t, s) && Fg(a, t, s, 'attributes', o, r) && Fg(a, t, s, 'styles', o, r)) {
                        var c = s.classes
                        if (c) for (var l = 0; l < c.length; l++) if (!e.dom.hasClass(t, pl(c[l], r))) return
                        return s
                    }
                }
        },
            ...
            ? ((l = e),
              ...
              xl(d) &&
                  (v
                      ...
                      : h.isBlock(f) && !h.isBlock(p) && (Fp(h, f, !1) || Fp(h, f.firstChild, !0, !0) || f.insertBefore(h.create('br'), f.firstChild), Fp(h, f, !0) || Fp(h, f.lastChild, !1, !0) || f.appendChild(h.create('br')))),
              (Sl((g = d)) && El(g) && ln(ae(g, 'mixed'), !0) && !Dh(d.inline, f)) || h.remove(f, !0),
              Ah.removed())
            : Ah.keep()
    }
            ...
            if (g.split) {
                if (((t = Vf(t)), (r = Pp(u, t, !0)) !== (o = Pp(u, t)))) {
                    if (((r = Lp(r, !0)), (o = Lp(o, !1)), Bp(h, r, o))) {
                        ...
                        return a(Mp(h, n, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void d(!0)
                    }
        ...
        var n,
            ...
            v = function (t) {
                ...
                X(['underline', 'line-through', 'overline'], function (e) {
                    Hn(t) && u.dom.getStyle(t, 'text-decoration') === e && t.parentNode && yl(h, t.parentNode) === e && zp(u, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: e } }, null, t)
                })
            }
            ...
            X(l.split(','), function (t) {
                ...
                var n,
                    r = ae(g, t).getOrThunk(function () {
                        var e = { withSimilar: { state: pu(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: pu(!1), similar: !1, callbacks: [] }, withVars: [] }
                        return (g[t] = e)
                    })
    ...
    function Qp(e, t) {
        for (var n = e.rows, r = 0; r < n.length; r++) for (var o = n[r].cells, i = 0; i < o.length; i++) if (je(o[i], t)) return he.some({ x: i, y: r })
        return he.none()
    }
                ...
                X(Au(n, 'td,th'), function (e, t) {
                    !(function (e, t, n, r, o) {
                        for (var i = Gp(o, 'rowspan'), a = Gp(o, 'colspan'), u = e.rows, s = n; s < n + i; s++) {
                            u[s] || (u[s] = Yp(Lu(r), []))
                            for (var c = t; c < t + a; c++) u[s].cells[c] = s === n && c === t ? o : Pu(o)
                        }
                    })(
                        o,
                        (function (e, t, n) {
    ...
    function lh(e, t, n) {
        ...
        'fragmented' === t.type
            ? ((r = t.fragments),
              ...
              sh(
                  ...
                  (c = function (e, t, n, r, o) {
                      var i = l(e, t, n, r)
                      if (null === i || (i.start === t && i.diag === t - r) || (i.end === e && i.diag === e - n)) for (var a = e, u = n; a < t || u < r; ) a < t && u < r && g[a] === p[u] ? (o.push([0, g[a]]), ++a, ++u) : r - n < t - e ? (o.push([2, g[a]]), ++a) : (o.push([1, p[u]]), ++u)
                      else {
            ...
            : e.setContent(t.content, { format: 'raw', no_selection: !V(s) || !el(s) || !s.isFakeCaret }),
    ...
    function vh(c) {
        return {
            undoManager: {
                ...
                undo: function (e, t, n) {
                    return (r = c), (i = t), (a = n), (o = e).typing && (o.add(), (o.typing = !1), ph(o, !1, i)), 0 < a.get() && (a.set(a.get() - 1), lh(r, (u = o.data[a.get()]), !0), r.setDirty(!0), r.fire('Undo', { level: u })), u
                    var r, o, i, a, u
                },
                redo: function (e, t) {
                    return (n = c), (o = t), (r = e).get() < o.length - 1 && (r.set(r.get() + 1), lh(n, (i = o[r.get()]), !1), n.setDirty(!0), n.fire('Redo', { level: i })), i
                    var n, r, o, i
                },
                clear: function (e, t) {
                    var n,
            ...
            editor: {
                getContent: function (e, t) {
                    return (
                        ...
                        (d = e),
                        (m = t),
                        he.from(f.getBody()).fold(J('tree' === d.format ? new Jd('body', 11) : ''), function (e) {
                            return (
                                (t = f),
                                (r = m),
                                (o = e),
                                (c = (n = d).no_events ? n : t.fire('BeforeGetContent', ke(ke({}, n), { format: r, get: !0, getInner: !0 }))),
                                (l =
                                    'raw' === c.format
                                        ...
                                        : ((a = (i = t).serializer.serialize(o, c)), (u = Ls(i)), (s = new RegExp('^(<' + u + '[^>]*>(&nbsp;|&#160;|\\s|\xa0|<br \\/>|)<\\/' + u + '>[\r\n]*|<br \\/>[\r\n]*)$')), a.replace(s, ''))),
                                ie(['text', 'tree'], c.format) || To(Et.fromDom(o)) ? (c.content = l) : (c.content = St.trim(l)),
            ...
            selection: {
                getContent: function (e, t) {
                    return (function (e, t, n) {
                        var r = e.fire('BeforeGetContent', ke(ke({}, (n = void 0 === n ? {} : n)), { format: t, get: !0, selection: !0 }))
                        if (r.isDefaultPrevented()) return e.fire('GetContent', r), r.content
                        if ('text' === r.format)
                            return (
                                (f = e),
                                he
                                    ...
                                    .map(function (e) {
                                        var t = he.from(f.dom.getParent(e.commonAncestorContainer, f.dom.isBlock)),
                                            n = f.getBody(),
                                            r = t
                                                .map(function (e) {
                                                    return e.nodeName
                        ...
                        var o,
                            ...
                            l,
                            f,
                            d = ((i = r), (a = (o = e).selection.getRng()), (u = o.dom.create('body')), (s = o.selection.getSel()), (c = Pd(o, Ml(s))), (l = i.contextual ? oh(Et.fromDom(o.getBody()), c).dom : a.cloneContents()) && u.appendChild(l), o.selection.serializer.serialize(u, i))
                        return 'tree' === r.format ? d : ((r.content = e.selection.isCollapsed() ? '' : d), e.fire('GetContent', r), r.content)
                    })(c, e, t)
                },
            },
            raw: {
                ...
                function (e) {
                    ...
                    return (
                        (u.rtcInstance =
                            ...
                            (n = J('')),
                            {
                                undoManager: { beforeChange: oe, add: t, undo: t, redo: t, clear: oe, reset: oe, hasUndo: T, hasRedo: T, transact: t, ignore: oe, extra: oe },
                                formatter: { match: T, matchAll: J([]), matchNode: J(void 0), canApply: T, closest: n, apply: oe, remove: oe, toggle: oe, formatChanged: J({ unbind: oe }) },
                                editor: { getContent: n, setContent: n, insertContent: oe, addVisual: oe },
    ...
    function Eh(e, t, n) {
        var r,
            o = ((r = t), ke(ke({ format: 'html' }, (n = void 0 === n ? {} : n)), { set: !0, selection: !0, content: r })),
            i = o
        if (!o.no_events) {
        ...
        Ph = function (S, E, N, r) {
                ...
                Il(w, e, function (e) {
                    var s,
                        c = function (e) {
                            ...
                            if (
                                (Hn(e) && w.getContentEditable(e) && ((n = f), (f = 'true' === w.getContentEditable(e)), (t = !0)),
                                Xn(e) &&
                                    !(function (e, t, n, r) {
                    ...
                    X(x, function (e) {
                        ...
                        ;(!(1 < x.length) && w.isBlock(e)) || 0 !== y
                            ? (El(A) || (xl(A) && A.wrapper)) &&
                              ...
                              (s = A),
                              (wp((u = S), (f = e).parentNode, (c = E), (l = N)) && zp(u, s, l, f)) ||
                                  (s.merge_with_parents &&
                                      u.dom.getParent(f.parentNode, function (e) {
                                          if (wp(u, e, c, l)) return zp(u, s, l, f), !0
                                      })),
                              (a = e),
                              (i = A).styles && i.styles.backgroundColor && _h(a, Dp(w, 'fontSize'), Op(w, 'backgroundColor', pl(i.styles.backgroundColor, N))),
                              (m = w),
                              (p = e),
                              (g = A).styles && (g.styles.color || g.styles.textDecoration) && (St.walk(p, C, 'childNodes'), C(p)),
                              (t = w),
                              (o = e),
                              !El((r = A)) || ('sub' !== r.inline && 'sup' !== r.inline) || (_h(o, Dp(t, 'fontSize'), Op(t, 'fontSize', '')), t.remove(t.select('sup' === r.inline ? 'sub' : 'sup', o), !0)),
                              Rp(w, A, 0, e))
                            : w.remove(e, !0)
                    })
            }
            ...
            if ('false' !== u.getContentEditable(s.getNode()))
                A &&
                    (r
                        ? ll(r)
                            ? g(_, r) || ((e = u.createRng()).setStartBefore(r), e.setEndAfter(r), o(u, Ll(S, e, _), !0))
                            : o(u, r, !0)
                        : a && El(A) && !Ul(S).length
                        ? (function (e, t, n) {
                              var r,
                              ...
                              u && 0 < a && a < u.length && m.test(u.charAt(a)) && m.test(u.charAt(a - 1))
                                  ? ((c = o.getBookmark()), i.collapse(!0), (l = Vf(Ll(e, i, e.formatter.get(t)))), e.formatter.apply(t, n, l), o.moveToBookmark(c))
                                  : ((s && r.nodeValue === xp) || ((f = e.getDoc()), (d = Hg(!0).dom), (r = (s = f.importNode(d, !0)).firstChild), i.insertNode(s), (a = 1)), e.formatter.apply(t, n, s), o.setCursorLocation(r, a))
                          })(S, E, N)
                        : ((t = s.getNode()),
                          (n = _[0]),
                          S.settings.forced_root_block || !n.defaultBlock || u.getParent(t, u.isBlock) || Ph(S, n.defaultBlock),
                ...
                if ((r = e) && (Fh(r) || (Uh(r.startContainer) && Uh(r.endContainer)))) {
                    ...
                    if (o) {
                        ...
                        e.collapsed ||
                            ...
                            !i.setBaseAndExtent ||
                            Ct.ie ||
                            (e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && (n = e.startContainer.childNodes[e.startOffset]) && 'IMG' === n.tagName && (i.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset), (i.anchorNode === e.startContainer && i.focusNode === e.endContainer) || i.setBaseAndExtent(n, 0, n, 1))),
            ...
            v = {
                ...
                getSelectedBlocks: function (e, t) {
                    return (function (e, t, n, r) {
                        var o = [],
                            i = e.getRoot()
                        if (((n = e.getParent(n || Dd(i, t, t.collapsed), e.isBlock)), (r = e.getParent(r || Od(i, t, t.collapsed), e.isBlock)), n && n !== i && o.push(n), n && r && n !== r)) for (var a, u = new jr(n, i); (a = u.next()) && a !== r; ) e.isBlock(a) && o.push(a)
                                ...
                                0 !== (o = f).src.indexOf('blob:')
                                    ? ((u = (a = Hh(o.src)).data),
                                      ...
                                      (l = r.getByData(c, s))
                                          ...
                                          : qh(o.src).then(
                                                function (e) {
                                                    ;(l = r.create($h(), e, c)), r.add(l), i({ image: o, blobInfo: l })
                                                },
                                                function (e) {
                                                    n(e)
                                                }
                                    ...
                                    : qh(o.src).then(
                                          function (t) {
                                              ...
                                              new _r(function (e) {
                                                  ...
                                                  ;(c = Hh(e).data), (l = r.create($h(), t, c)), r.add(l), i({ image: o, blobInfo: l })
                                              })
                                          },
                                          function (e) {
                                              n(e)
    ...
    function Yh(e, p) {
        ...
        function n(t) {
            ...
            ;(e = t).attr('src') === Ct.transparentSrc ||
                ...
                ((n = /data:([^;]+);base64,([a-z0-9\+\/=\s]+)/i.exec(r)) ? he.some({ type: n[1], data: decodeURIComponent(n[2]) }) : he.none())
                    .filter(function () {
                        return (function (e, t) {
    ...
    function Gh(_, A) {
        ...
        var e = {
            ...
            addAttributeFilter: function (e, n) {
                vv(bv(e), function (e) {
                    for (var t = 0; t < R.length; t++) if (R[t].name === e) return void R[t].callbacks.push(n)
            ...
            parse: function (e, u) {
                ...
                if (
                    ...
                    for (a in D)
                        if (Ee(D, a)) {
                            for (s = T[a], o = (t = D[a]).length; o--; ) t[o].parent || t.splice(o, 1)
                                ...
                                (d = I) && d.hasEventListeners('PreProcess') && !E.no_events
                                    ? ((h = g),
                                      ...
                                      (S = document.implementation).createHTMLDocument &&
                                          ...
                                          St.each('BODY' === x.nodeName ? x.childNodes : [x], function (e) {
    ...
    function av(e, t, n, r, o) {
        var i,
            ...
            f,
            d,
            m = e ? { mobile: ((i = t), (a = { resize: !1, toolbar_mode: ov(o.mobile || {}, 'scrolling'), toolbar_sticky: !1 }), ke(ke(ke({}, _v), a), i ? { menubar: !1 } : {})) } : {},
            g =
                ((c = ['mobile']),
                te(
                    wv(m, o),
            ...
            p = St.extend(
                ...
                e && rv(g, 'mobile')
                    ...
                    : {},
                { validate: !0, external_plugins: ((u = r), (s = g.settings().external_plugins || {}), u && u.external_plugins ? St.extend({}, u.external_plugins, s) : s) }
            )
        return iv(e, g, r, p)
    }
    function uv(e, t, n) {
    ...
    function fv(o) {
        ...
        function t(n, e) {
            if ((void 0 === e && (e = !0), !o.removed && ((r = (t = o).inline ? t.getBody() : t.getContentAreaContainer()), he.from(r).map(Et.fromDom).map(Fn).getOr(!1))))
                return (
                    ...
                    I(c, function (e) {
                        ...
                        return c.push(e), u(), o.fire('OpenNotification', { notification: ke({}, e) }), e
                    })
                )
            var t, r
        }
    ...
    function qv() {
        ...
        function i(e) {
            ...
            return {
                id: J(t),
                name: J(n),
                filename: J(e.filename || n + '.' + ({ 'image/jpeg': 'jpg', 'image/jpg': 'jpg', 'image/gif': 'gif', 'image/png': 'png', 'image/apng': 'apng', 'image/avif': 'avif', 'image/svg+xml': 'svg', 'image/webp': 'webp', 'image/bmp': 'bmp', 'image/tiff': 'tiff' }[r.type.toLowerCase()] || 'dat')),
                blob: J(r),
                base64: J(e.base64),
    ...
    function Kv(e, t) {
        return $v(t, { url: e.getParam('images_upload_url', '', 'string'), basePath: e.getParam('images_upload_base_path', '', 'string'), credentials: e.getParam('images_upload_credentials', !1, 'boolean'), handler: e.getParam('images_upload_handler', null, 'function') })
    }
    function Xv(l) {
        function t(t) {
            return function (e) {
                                    ...
                                    t = R(e, function (e, t) {
                                        ...
                                        return (
                                            e.status && l.getParam('images_replace_blob_uris', !0, 'boolean')
                                                ? (m.removeByUri(u.src), bh(l) || ((r = u), (o = e.url), (i = l.convertURL(o, 'src')), f(r.src, o), l.$(r).attr({ src: l.getParam('images_reuse_filename', !1, 'boolean') ? o + (-1 === o.indexOf('?') ? '?' : '&') + new Date().getTime() : o, 'data-mce-src': i })))
                ...
                }),
                {
                    fireIfChanged: function () {
                        ...
                        Y(t)
                            ...
                            .each(function (e) {
                                c.setDirty(!0), c.fire('change', { level: e, lastLevel: $(t, t.length - 2).getOrNull() })
                            })
                    },
                }),
            v = function () {
        ...
        return (
            ...
            !yb((u = i), (s = a).startContainer) && !yb(u, s.endContainer) && c && l
                ...
                : ((n = f),
                  (r = e.selection),
                  (o = r.getRng()),
                  fn(ub(n, Et.fromDom(o.startContainer)), ub(n, Et.fromDom(o.endContainer)), function (e, t) {
                      return (
                          !1 === je(e, t) &&
                          (o.deleteContents(),
    ...
    function Sb(e, t) {
        var n, r
        return e.fire('BeforeObjectSelected', { target: t }).isDefaultPrevented() ? he.none() : he.some(((r = (n = t).ownerDocument.createRange()).selectNode(n), r))
    }
    function Eb(e, t, n) {
                    ...
                    (!1 === c && up(f)
                        ...
                        : ((r = s),
                          ...
                          Hn(a) && a.getAttribute('data-mce-caret') === u
                              ? ((n = o.getNode(!1 === (t = e))),
                                (t && Jn(n.nextSibling) ? he.some(wy.moveToElement(n.nextSibling)) : !1 === t && Jn(n.previousSibling) ? he.some(wy.moveToElement(n.previousSibling)) : he.none()).fold(function () {
                                    return Rb(r, e, o)
                                }, he.some))
            ...
            g.on('NodeChange', function (e) {
                ...
                !Ws(g) ||
                    ...
                    X(
                        q(
                            (s = U(
                                R(Au(Et.fromDom(a.getRoot()), '*[data-mce-selected="inline-boundary"]'), function (e) {
                                    return e.dom
                                }),
                                i
                            )),
                    ...
                    X(q(c, s), A(r0, !0)),
                    (f = p),
                    (l = g).selection.isCollapsed() && !0 !== l.composing && f.get() && ((d = bs.fromRangeStart(l.selection.getRng())), bs.isTextPosition(d) && !1 === (Gr((m = d)) || Jr(m)) && (n0(l, Zs(f.get(), d)), f.set(null))),
                    (n = h),
                    (r = g),
                    (o = p),
                    (t = e.parents),
        ...
        return Y(h).exists(function (e) {
            ...
            return !(
                ...
                (c = R(U(h, A(Yg, (r = g))), function (e) {
                    ...
                    ? tg(r, n, o)
                    : ((a = o.dom), (s = Wg(c, (u = Hg(!1)).dom)), Vt(Et.fromDom(a), u), Mn(Et.fromDom(a)), (i = bs(s, 0)), r.selection.setRng(i.toRange())),
                0)
            )
        })
    }
                    ...
                    (p = u),
                        qn((h = s)) || (Hn(h) && !N0(p, h) && !ul(h))
                            ? (function (e, t) {
                                ...
                                : (t || ((t = o.create(l, Is(e))), s.parentNode.insertBefore(t, s), (r = !0)), (s = (n = s).nextSibling), t.appendChild(n))
    ...
    function U0(e, t) {
        return I(
            ...
            z(
                R(e, function (e) {
                    return ke({ shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: oe }, e)
                }),
                function (e) {
    ...
    function V0(e, t, n, r, o) {
        var i,
            ...
            u = U(
                ...
                z(a, function (e) {
                    var t,
                        n = { left: (t = Fu(e.getBoundingClientRect())).left - -1, top: t.top - -1, right: t.right + -2, bottom: t.bottom + -2, width: t.width + -1, height: t.height + -1 }
                    return [
    ...
    function q0(e, t, n) {
        var r,
            o,
            i = e(t, n)
        return (i.breakType === sy.Wrap && 0 === i.positions.length) || (!Xn(n.getNode()) && i.breakType === sy.Br && 1 === i.positions.length)
            ? ((r = e),
              (o = t),
    ...
    function cC(a, e) {
        function t(e) {
            ...
            else for (; r[n.nodeName] && (Qc(n) || ul(n) || ((t = n.cloneNode(!1)), c.setAttrib(t, 'id', ''), o.hasChildNodes() ? t.appendChild(o.firstChild) : (i = t), o.appendChild(t))), (n = n.parentNode) && n !== F; );
        ...
        F &&
            ...
            'LI' !== (w = y ? y.nodeName.toUpperCase() : '') || v || ((y = (b = y).parentNode), (C = w)),
            /^(LI|DT|DD)$/.test(C) && c.isEmpty(b)
                ? ((N = t),
                  ...
                  k !== E.getBody() &&
                      ((R = (A = eC((T = k)) && eC(T.parentNode) ? 'LI' : A) ? N(A) : I.create('BR')),
                      nC(k, _, !0) && nC(k, _, !1)
                          ? Z0(k, 'LI')
                              ? ((D = tC(k)), I.insertAfter(R, D), (null === (L = (P = k).parentNode) || void 0 === L ? void 0 : L.firstChild) === P ? I.remove(D) : I.remove(k))
                              : I.replace(R, k)
                          : (nC(k, _, !0)
                                ? Z0(k, 'LI')
                                    ? (I.insertAfter(R, tC(k)), R.appendChild(I.doc.createTextNode(' ')), R.appendChild(k))
                                    : k.parentNode.insertBefore(R, k)
                                : nC(k, _, !1)
                                ? I.insertAfter(R, tC(k))
                                : ((k = tC(k)), (O = M.cloneRange()).setStartAfter(_), O.setEndAfter(k), (B = O.extractContents()), 'LI' === A && B.firstChild && 'LI' === B.firstChild.nodeName ? ((R = B.firstChild), I.insertAfter(B, k)) : (I.insertAfter(B, k), I.insertAfter(R, k))),
                            I.remove(_)),
                      J0(E, R)))
                : (p && b === a.getBody()) ||
                  ((p = p || 'P'),
                  Wr(b)
                      ...
                      ? r()
                      : n(!0)
                      ? ((u = b.parentNode.insertBefore(t(), b)), J0(a, oC(b, 'HR') ? u : b))
                      : ((S = (x = d).cloneRange()).setStart(x.startContainer, aC(!0, x.startContainer, x.startOffset)),
            ...
            : (function (e, t) {
                  ...
                  'LI' !== d || m || (l = f),
                      c &&
                          ...
                          !(function (e) {
                              for (var t, n = new jr(c, l), r = e.getNonEmptyElements(); (t = n.next()); ) if (r[t.nodeName.toLowerCase()] || 0 < t.length) return 1
                          })(e.schema) &&
    ...
    function AC(e, t) {
        ...
        ;(n = e),
            (r = t),
            qb(
                [_C([bC], GC.none()), _C([wC('summary', !0)], GC.br()), _C([xC(!0), SC(!1), NC], GC.br()), _C([xC(!0), SC(!1)], GC.block()), _C([xC(!0), SC(!0), NC], GC.block()), _C([xC(!0), SC(!0)], GC.br()), _C([CC(!0), NC], GC.br()), _C([CC(!0)], GC.block()), _C([yC(!0), NC, kC], GC.block()), _C([yC(!0)], GC.br()), _C([EC], GC.br()), _C([yC(!1), NC], GC.br()), _C([kC], GC.block())],
                [n, !(!r || !r.shiftKey)]
            )
                .getOr(GC.none())
                .fold(
    ...
    function LC(e) {
        ...
        return (
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    U0(
                        [
                            ...
                            { keyCode: $f.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: F0(jC, t, n) },
                            { keyCode: $f.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: F0(HC, t, n) },
            ...
            (c = e).on('keydown', function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ((t = e),
                    U0([{ keyCode: $f.SPACEBAR, action: F0(PC, c) }], t).each(function (e) {
                        t.preventDefault()
                    }))
            }),
            (n = t = e),
    ...
    function n1(r) {
        ...
        'onselectionchange' in r.getDoc() ||
            ...
            r.on('SelectionChange', function () {
                ...
                !e || (!Ct.range && r.selection.isCollapsed()) || (Vl(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({ selectionChange: !0 }))
            }),
                ...
                D1((a = t)) &&
                    ...
                    u.set({
                        ...
                        ghost: (function (e, t, n) {
                            ...
                            return r.setStyles(i, { position: 'absolute', opacity: 0.5, overflow: 'hidden', border: 0, padding: 0, margin: 0, width: t, height: n }), r.setStyles(o, { margin: 0, boxSizing: 'border-box' }), i.appendChild(o), i
    ...
    function l1(l) {
        ...
        function d(e, t, n, r) {
            return void 0 === r && (r = !0), l.fire('ShowCaret', { target: t, direction: e, before: n }).isDefaultPrevented() ? null : (r && p.scrollIntoView(t, -1 === e), s.show(n, t))
        }
        function t(e) {
                ...
                if (f(c))
                    return (function (e) {
                        ...
                        var r = (function (e, t, n) {
                            ...
                            o = Et.fromDom(e)
                        return (
                            X(Au(Et.fromDom(l.getBody()), '*[data-mce-selected]'), function (e) {
                                je(o, e) || bn(e, y)
                            }),
        ...
        return (
            Ct.ceFalse &&
                    ...
                    ;(o !== v && 'HTML' !== o.nodeName && !h.isChildOf(o, v)) ||
                        ...
                        ((t = c1(l, o))
                            ? L1(t)
                                ...
                                : (a(), (P1(t) && e.shiftKey) || Af(e.clientX, e.clientY, p.getRng()) || (C(), p.placeCaretAt(e.clientX, e.clientY)))
                            : f(o)
                            ? Sb(l, o).each(c)
                            : !1 === rc(o) && (a(), C(), (n = Gy(v, e.clientX, e.clientY)) && (w(o, n.node) || (e.preventDefault(), (r = d(1, n.node, n.before, !1)), l.getBody().focus(), i(r)))))
                }),
                ...
                l.on('SetSelectionRange', function (e) {
                    var t, n, r, o, i, a, u
                    e.range =
                        ((t = e.range), (n = l.schema.getShortEndedElements()), (r = h.createRng()), (o = t.startContainer), (i = t.startOffset), (a = t.endContainer), (u = t.endOffset), Ee(n, o.nodeName.toLowerCase()) ? (0 === i ? r.setStartBefore(o) : r.setStartAfter(o)) : r.setStart(o, i), Ee(n, a.nodeName.toLowerCase()) ? (0 === u ? r.setEndBefore(a) : r.setEndAfter(a)) : r.setEnd(a, u), r)
    ...
    function f1(a) {
        ...
        return (
            bh(a)
                ? (S && (n(), o(), g(), t(), Ct.iOS && (l(), f(), m())), w && (r(), s(), c(), d()))
                : (a.on('keydown', function (e) {
                  ...
                  a.on('keydown', function (e) {
                      ...
                      u(e) ||
                          (i !== v && i !== h) ||
                          ((t = a.selection.isCollapsed()), (n = a.getBody()), (t && !b.isEmpty(n)) || (!t && ((r = T(a.selection.getRng())), (o = b.createRng()).selectNode(a.getBody()), r !== T(o))) || (e.preventDefault(), a.setContent(''), n.firstChild && b.isBlock(n.firstChild) ? a.selection.setCursorLocation(n.firstChild, 0) : a.selection.setCursorLocation(n, 0), a.nodeChanged()))
                  }),
                  Ct.windowsPhone ||
                      a.on(
                      ...
                      a.on('drop', function (e) {
                          ...
                          u(e) ||
                              ((t = e.dataTransfer && (o = e.dataTransfer.getData(N)) && 0 <= o.indexOf(E) ? ((o = o.substr(E.length).split(',')), { id: unescape(o[0]), html: unescape(o[1]) }) : null) &&
                                  t.id !== a.id &&
                                  (e.preventDefault(), (n = Pf(e.x, e.y, a.getDoc())), y.setRng(n), (r = t.html), a.queryCommandSupported('mceInsertClipboardContent') ? a.execCommand('mceInsertClipboardContent', !1, { content: r, internal: !0 }) : a.execCommand('mceInsertContent', !1, r)))
                      })),
                  w &&
                      (a.on('keydown', function (e) {
    ...
    function v1(e) {
        var t
        !0 !== e.removed && (bh((t = e)) || t.load({ initial: !0, format: 'html' }), (t.startContent = t.getContent({ format: 'raw' })), g1(e))
    }
    function b1(t, e) {
        var n = t.settings,
            r = t.getElement(),
        ...
        ;(h.disabled = !0),
            ...
            t.readonly || (t.inline && 'static' === I1.getStyle(h, 'position', !0) && (h.style.position = 'relative'), (h.contentEditable = t.getParam('content_editable_state', !0))),
            (h.disabled = !1),
            (t.editorUpload = Xv(t)),
            (t.schema = go(n)),
            (t.dom = cu(o, {
            ...
            (t.parser =
                ((i = Gh(m1((u = t)), u.schema)).addAttributeFilter('src,href,style,tabindex', function (e, t) {
                    ...
                    p.cancel(),
                        'touchcancel' !== t.type &&
                            m
                                ...
                                .each(function () {
                                    g.get() ? t.preventDefault() : d.fire('tap', ke(ke({}, t), { type: 'tap' }))
                                })
                },
                !0
            ),
        ...
        ;(N = k),
            ...
            (C = (y = t).dom),
            (w = Ls(y)),
            (x = y.getParam('placeholder', kc.getAttrib(y.getElement(), 'placeholder'), 'string')),
            (S = function (e, t) {
                var n, r, o
                !(function (e) {
                    if (tb(e)) {
                    ...
                    ((n = y.getBody()),
                    (r =
                        !(tb((o = e)) && !(nb(o) || ('keyup' === o.type && 229 === o.keyCode))) &&
                        (function (e, t, n) {
                    ...
                    (('' !== C.getAttrib(n, py)) === r && !t) || (C.setAttrib(n, py, r ? x : null), C.setAttrib(n, 'aria-placeholder', r ? x : null), y.fire('PlaceholderToggle', { state: r }), y.on(r ? 'keydown' : 'keyup', S), y.off(r ? 'keyup' : 'keydown', S)))
            }),
            x &&
                    ...
                    t.setProgressState(!0),
                        h1(t).then(function () {
                            e().then(
                                ...
                                function (e) {
                                    t.notificationManager.open({ type: 'error', text: String(e) }), v1(t)
                                }
                            )
                        })
                }
    ...
    function x1(e) {
        ...
        return (
            ...
            K($s(e))
                ? e.theme.renderUI()
                : y($s(e))
                ? ((n = (t = e).getElement()), (r = $s(t)(t, n)).editorContainer.nodeType && (r.editorContainer.id = r.editorContainer.id || t.id + '_parent'), r.iframeContainer && r.iframeContainer.nodeType && (r.iframeContainer.id = r.iframeContainer.id || t.id + '_iframecontainer'), (r.height = r.iframeHeight || n.offsetHeight), r)
                : ((u = (o = e).getElement()), o.inline ? w1(null) : ((i = u), (a = F1.create('div')), F1.insertAfter(a, i), w1(a)))
        )
    }
    function S1(e) {
        var n, t, r, o, i, a, u, s
        e.fire('ScriptsLoaded'),
            ...
            (a = $s((o = e))),
            K(a) ? ((o.settings.theme = C1(a)), (i = Pv.get(a)), (o.theme = new i(o, Pv.urls[a])), o.theme.init && o.theme.init(o, Pv.urls[a] || o.documentBaseUrl.replace(/\/$/, ''), o.$)) : (o.theme = {}),
            (s = []),
    ...
    function N1(t, e, n) {
        return he
            ...
            .map(function (e) {
                return { url: t.editorManager.baseURL + '/icons/' + e + '/icons' + n + '.js', name: he.some(e) }
            })
    }
    function k1(c, l) {
        var e,
            ...
            i = $s((e = c))
        K(i)
            ? (E1(i) || Ee(Pv.urls, i) || ((t = e.getParam('theme_url')) ? Pv.load(i, e.documentBaseURI.toAbsolute(t)) : Pv.load(i, 'themes/' + i + '/theme' + r + '.js')),
        ...
        U1 = function (t, n, r) {
            ...
            if (
                ...
                try {
                    ...
                    ;(i = r), (a = e), Tf((o = t), 'PluginLoadError', { message: (u = yu.translate(['Failed to initialize plugin: {0}', i])) }), uy(u, a), Mv(o, u)
                }
        },
        z1 = cu.DOM,
            ...
            (X1.prototype.setupCommands = function (u) {
                ...
                this.addCommands({
                    ...
                    'Cut,Copy,Paste': function (e) {
                        ...
                        ;(!(t = ('paste' === e && !r.queryCommandEnabled(e)) || t) && r.queryCommandSupported(e)) || ((n = u.translate("Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.")), Ct.mac && (n = n.replace(/Ctrl\+/g, '\u2318+')), u.notificationManager.open({ text: n, type: 'error' }))
                    },
                    unlink: function () {
                        var e
                    ...
                    mceInsertContent: function (e, t, n) {
                        ...
                        ;(r = u),
                            (o = (function (e) {
                                ...
                                var t = St.extend({ paste: e.paste, data: { paste: e.paste } }, e)
              ...
              Nu((r = e))
                  ...
                  : ((u = o),
                    ...
                    (s = U(Eu((a = r), 'class'), function (e) {
                        ...
                        ? gn(a, 'class', s.join(' '))
                        : bn(a, 'class')),
              0 === (Nu((i = r)) ? i.dom.classList : Eu(i, 'class')).length && bn(i, 'class'))
            : n && ku(e, t)
    }
    function G1(e, t, n) {
        try {
    ...
    var fw,
        ...
        Cw =
            ...
            (ww.prototype.createShortcut = function (e, t, n, r) {
                ...
                return (o[o.length - 1] = St.extend(o[o.length - 1], { func: n, scope: r || this.editor })), St.extend(o[0], { desc: this.editor.translate(t), subpatterns: o.slice(1) })
            }),
    ...
    var xw = St.each,
        ...
        kw =
            ...
            (_w.prototype.getURI = function (e) {
                ...
                return (
                    void 0 === e && (e = !1),
                    (this.source && !e) || ((t = ''), e || (this.protocol ? (t += this.protocol + '://') : (t += '//'), this.userInfo && (t += this.userInfo + '@'), this.host && (t += this.host), this.port && (t += ':' + this.port)), this.path && (t += this.path), this.query && (t += '?' + this.query), this.anchor && (t += '#' + this.anchor), (this.source = t)),
                    this.source
                )
            }),
            _w)
    function _w(e, t) {
        ...
        ;/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)
            ...
            : ((n = 0 === e.indexOf('//')),
              ...
              /^[\w\-]*:?\/\//.test(e) || ((r = this.settings.base_uri ? this.settings.base_uri.path : new _w(document.location.href).directory), (e = this.settings.base_uri && '' == this.settings.base_uri.protocol ? '//mce_host' + u.toAbsPath(r, e) : ((o = /([^#?]*)([#?]?.*)/.exec(e)), ((a && a.protocol) || 'http') + '://mce_host' + u.toAbsPath(r, o[1]) + o[2]))),
    ...
    var Aw = cu.DOM,
        ...
        Bw =
                ...
                !(function (t) {
                    ...
                    bi.Event.domLoaded
                        ? t.getElement() &&
                          ...
                          (t.ui.styleSheetLoader = zr.forElement(n, { contentCssCors: (o = t).getParam('content_css_cors'), referrerPolicy: Us(o) })),
                          ...
                          (i = t.getElement().form || z1.getParent(e, 'form')) &&
                              ((t.formElement = i),
                              t.getParam('hidden_input') && !Vn(t.getElement()) && (z1.insertAfter(z1.create('input', { type: 'hidden', name: e }), e), (t.hasHiddenInput = !0)),
            ...
            (Pw.prototype.execCallback = function (e) {
                ...
                var r,
                    o = this.settings[e]
                if (o) return this.callbackLookup && (r = this.callbackLookup[e]) && ((o = r.func), (r = r.scope)), 'string' == typeof o && ((r = (r = o.replace(/\.\w+$/, '')) ? Dw(r) : 0), (o = Dw(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })), o.apply(r || this, t)
            }),
            ...
            (Pw.prototype.getParam = function (e, t, n) {
                return (
                    ...
                    'hash' === a
                        ? ((c = {}),
                          'string' == typeof (s = l)
                              ? X(0 < s.indexOf('=') ? s.split(/[;,](?![^=;,]*(?:[;,]|$))/) : s.split(','), function (e) {
                                    var t = e.split('=')
            ...
            (Pw.prototype.insertContent = function (e, t) {
                t && (e = Tw({ content: e }, t)), this.execCommand('mceInsertContent', !1, e)
            }),
            (Pw.prototype.resetContent = function (e) {
                void 0 === e ? ev(this, this.startContent, { format: 'raw' }) : ev(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
            }),
            ...
            (Pw.prototype.destroy = function (e) {
                ...
                ;(n = e),
                    ...
                    t.destroyed ||
                        (n || t.removed
                            ? (n || (t.editorManager.off('beforeunload', t._beforeUnload), t.theme && t.theme.destroy && t.theme.destroy(), tv(a), tv(u)),
                              (o = (r = t).formElement) && (o._mceOldSubmit && ((o.submit = o._mceOldSubmit), (o._mceOldSubmit = null)), Cv.unbind(o, 'submit reset', r.formEventDelegate)),
    ...
    function Pw(e, t, n) {
        ...
        ;(this.plugins = {}),
            ...
            this.settings.referrer_policy && (mu.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy), cu.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
            (Cu.languageLoad = this.settings.language_load),
            (Cu.baseURL = n.baseURL),
            (this.id = e),
            this.setDirty(!1),
            (this.documentBaseURI = new kw(this.settings.document_base_url, { base_uri: this.baseUri })),
            (this.baseURI = this.baseUri),
            (this.inline = !!this.settings.inline),
            (this.shortcuts = new Cw(this)),
            (this.editorCommands = new K1(this)),
            this.settings.cache_suffix && (Ct.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, '')),
            (this.ui = {
                registry: {
                    addAutocompleter:
                        ((u = {}),
        ...
        var x,
            ...
            _ =
                ((N = pu('design')),
                (k = pu({ design: { activate: oe, deactivate: oe, editorReadOnly: !1 }, readonly: { activate: oe, deactivate: oe, editorReadOnly: !0 } })),
                (S = x = this).serializer
                    ? ew(S)
        ...
        ;(this.mode = _),
            ...
            (this.$ = ou.overrideDefaults(function () {
                return { context: C.inline ? C.getBody() : C.getDoc(), element: C.getBody() }
            }))
    }
    function Lw(t) {
        var n = t.type
    ...
    var Fw,
        ...
        Xw = ke(ke({}, dw), {
            ...
            add: function (e) {
                ...
                return (
                    $w[e.id] === e ||
                        (null === n.get(e.id) && ('length' !== e.id && ($w[e.id] = e), $w.push(e), Ww.push(e)),
                        Iw(!0),
                        (n.activeEditor = e),
    ...
    var Qw,
        ...
        ix = {
            ...
            findBestRelativePosition: function (e, t, n, r) {
                for (var o, i = 0; i < r.length; i++) if ((o = Yw(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i]
                return null
            },
    ...
    Gw.extend = ex = function (n) {
        function r() {
            var e, t, n
            if (!tx && (this.init && this.init.apply(this, arguments), (t = this.Mixins))) for (e = t.length; e--; ) (n = t[e]).init && n.init.apply(this, arguments)
        }
        function t() {
            return this
        }
        ...
        yx =
            ...
            (Cx.prototype.send = function (e) {
                ...
                ;(o.success = function (e, t) {
                    ...
                    (o.data = px.serialize({ id: e.id || 'c' + this.count++, method: e.method, params: e.params })),
            ...
            util: {
                ...
                Color: function (e) {
                    ...
                    return (
                        ...
                        (n.toHsv = function () {
                            return (e = u), (t = s), (n = c), (o = 0), (i = dx((e /= 255), dx((t /= 255), (n /= 255)))) === (a = mx(e, mx(t, n))) ? { h: 0, s: 0, v: 100 * (o = i) } : ((r = (a - i) / a), { h: gx(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: gx(100 * r), v: gx(100 * o) })
                            var e, t, n, r, o, i, a
                        }),
                        (n.toHex = function () {
                            function e(e) {
