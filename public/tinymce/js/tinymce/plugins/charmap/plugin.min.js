...
!(function () {
    ...
    var t,
        ...
        a = function (e) {
            return (n = typeof (r = e)), (null === r ? 'null' : 'object' == n && (Array.prototype.isPrototypeOf(r) || (r.constructor && 'Array' === r.constructor.name)) ? 'array' : 'object' == n && (String.prototype.isPrototypeOf(r) || (r.constructor && 'String' === r.constructor.name)) ? 'string' : n) === t
            var r, n
        },
        m = i(!(t = 'array')),
        o = i(!(g = null)),
    ...
    function h(e) {
        var r = (function (e, r) {
            ...
            if (t) {
                ...
                return a.length ? ((a[0].characters = [].concat(a[0].characters).concat(s(t))), r) : r.concat({ name: O, characters: s(t) })
            }
            return r
        })(e, [
            {
