...
!(function () {
    ...
    tinymce.util.Tools.resolve('tinymce.PluginManager').add('code', function (e) {
        ...
        return (
            ...
            (o = e).ui.registry.addButton('code', { icon: 'sourcecode', tooltip: 'Source code', onAction: n }),
            o.ui.registry.addMenuItem('code', { icon: 'sourcecode', text: 'Source code', onAction: n }),
            {}
        )
    })
})()
