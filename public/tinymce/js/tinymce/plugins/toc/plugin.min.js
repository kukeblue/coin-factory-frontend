...
!(function () {
    ...
    function d(t) {
        ...
        if (!i.length) return ''
        r += ((e = s(t)), (n = v.translate('Table of Contents')), (o = '</' + e + '>'), '<' + e + ' contenteditable="true">' + m.DOM.encode(n) + o)
        for (var l = 0; l < i.length; l++) {
            ...
            if (((r += '<a href="#' + a.id + '">' + a.title + '</a>'), u !== a.level && u)) for (d = a.level; u < d; d--) r += '</li></ul><li>'
            else (r += '</li>'), u || (r += '</ul>')
            c = a.level
        }
        return r
    ...
    var t,
        ...
        g = function (n) {
            ...
            return (
                ...
                c.map(i, function (t) {
                    return { id: t.id || l(), level: parseInt(t.nodeName.replace(/^H/i, ''), 10), title: n.$.text(t), element: t }
                })
            )
        }
    e.add('toc', function (t) {
        ...
        ;(c = t).addCommand('mceInsertToc', function () {
            var t, e, n, o, r, i
            ;(o = a((t = c))), (r = t.$('.' + o)), (i = t), !r.length || 0 < i.dom.getParents(r[0], '.mce-offscreen-selection').length ? t.insertContent(((n = d((e = t))), '<div class="' + e.dom.encode(a(e)) + '" contenteditable="false">' + n + '</div>')) : f(t)
        }),
            c.addCommand('mceUpdateToc', function () {
                f(c)
            }),
            (r = t).ui.registry.addButton('toc', { icon: 'toc', tooltip: 'Table of contents', onAction: l, onSetup: u(r) }),
            ...
            r.ui.registry.addMenuItem('toc', { icon: 'toc', text: 'Table of contents', onAction: l, onSetup: u(r) }),
